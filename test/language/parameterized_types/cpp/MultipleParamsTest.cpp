...
TEST_F(MultipleParamsTest, arrayLength)
{
    ...
    zserio::View<TestStructure> view(data, 1, 1);
...
TEST_F(MultipleParamsTest, dynBitField)
{
    ...
    zserio::View<TestStructure> view(data, 1, 15);
...
TEST_F(MultipleParamsTest, comparisonOperators)
{
    ...
    zserio::View<TestStructure> view(data, static_cast<uint32_t>(array5.size()), 15);
    zserio::View<TestStructure> equalView(equalData, static_cast<uint32_t>(array5.size()), 15);
    zserio::View<TestStructure> lessThenView(lessThenData, static_cast<uint32_t>(array5.size()), 15);
...
{
    {
        ...
        const TestStructure data;
        zserio::View<TestStructure> view(data, std::numeric_limits<uint32_t>::max(), 1);
        ASSERT_THROW(zserio::detail::validate(view), zserio::OutOfRangeException);
    }
    {
        // parameter bitFieldLength is out of range
        const TestStructure data;
        zserio::View<TestStructure> view(data, 1, 16);
        ASSERT_THROW(zserio::detail::validate(view), zserio::OutOfRangeException);
    }
