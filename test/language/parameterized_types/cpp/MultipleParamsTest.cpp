...
TEST_F(MultipleParamsTest, array5)
{
    ...
    zserio::ArrayView<const zserio::UInt5> expectedArray5View(array5);
...
TEST_F(MultipleParamsTest, array13)
{
    ...
    zserio::ArrayView<const Data13, zserio::View<TestStructure>::ZserioArray13ArrayTraits> expectedArray13View(
            array13, view);
