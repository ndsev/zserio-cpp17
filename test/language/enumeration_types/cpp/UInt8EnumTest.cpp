...
{
protected:
    static const uint8_t DARK_COLOR_BITSIZEOF;

    static const zserio::UInt8 NONE_VALUE;
    static const zserio::UInt8 DARK_RED_VALUE;
    static const zserio::UInt8 DARK_BLUE_VALUE;
    static const zserio::UInt8 DARK_GREEN_VALUE;

    zserio::BitBuffer bitBuffer = zserio::BitBuffer(1024 * 8);
};

const uint8_t UInt8EnumTest::DARK_COLOR_BITSIZEOF = 8;

const zserio::UInt8 UInt8EnumTest::NONE_VALUE = 0;
const zserio::UInt8 UInt8EnumTest::DARK_RED_VALUE = 1;
const zserio::UInt8 UInt8EnumTest::DARK_BLUE_VALUE = 2;
const zserio::UInt8 UInt8EnumTest::DARK_GREEN_VALUE = 7;
