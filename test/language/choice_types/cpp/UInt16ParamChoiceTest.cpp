...
{
    {
        ...
        ASSERT_EQ(UInt16ParamChoice::Tag::ZSERIO_UNDEFINED, data.index());
    }
    {
        UInt16ParamChoice data = {};
        ASSERT_EQ(UInt16ParamChoice::Tag::ZSERIO_UNDEFINED, data.index());
    ...
    {
        UInt16ParamChoice data(zserio::in_place_index<UInt16ParamChoice::Tag::valueA>, 99);
        zserio::View view(data, VARIANT_A_SELECTOR);
        ASSERT_EQ(UInt16ParamChoice::Tag::valueA, view.zserioChoiceTag());
    }
}
...
TEST_F(UInt16ParamChoiceTest, copyConstructor)
{
    ...
    data.emplace<UInt16ParamChoice::Tag::valueA>(value);
...
TEST_F(UInt16ParamChoiceTest, moveConstructor)
{
    ...
    ASSERT_EQ(value, zserio::get<UInt16ParamChoice::Tag::valueA>(dataMoved));
...
{
    UInt16ParamChoice data;
    data.emplace<UInt16ParamChoice::Tag::valueA>(0);
...
TEST_F(UInt16ParamChoiceTest, zserioChoiceTag)
{
    ...
    {
        UInt16ParamChoice data;
        data.emplace<UInt16ParamChoice::Tag::valueB>(0);
        zserio::View viewB(data, VARIANT_B_SELECTOR1);
        ASSERT_EQ(UInt16ParamChoice::Tag::valueB, viewB.zserioChoiceTag());
    }
    {
        UInt16ParamChoice data;
        data.emplace<UInt16ParamChoice::Tag::valueC>(0);
        zserio::View viewC(data, EMPTY_SELECTOR2);
        ASSERT_EQ(UInt16ParamChoice::Tag::valueC, viewC.zserioChoiceTag());
    }
}
...
TEST_F(UInt16ParamChoiceTest, valueA)
{
    ...
    const VariantA value = 99;
    data.emplace<UInt16ParamChoice::Tag::valueA>(value);
    ASSERT_THROW(zserio::get<UInt16ParamChoice::Tag::valueB>(data), zserio::BadVariantAccess);
    ASSERT_THROW(zserio::get<UInt16ParamChoice::Tag::valueC>(data), zserio::BadVariantAccess);
    ASSERT_EQ(value, zserio::get<UInt16ParamChoice::Tag::valueA>(data));
...
TEST_F(UInt16ParamChoiceTest, valueB)
{
    ...
    UInt16ParamChoice data(zserio::in_place_index<UInt16ParamChoice::Tag::valueB>, value);
    ASSERT_THROW(zserio::get<UInt16ParamChoice::Tag::valueA>(data), zserio::BadVariantAccess);
    ASSERT_THROW(zserio::get<UInt16ParamChoice::Tag::valueC>(data), zserio::BadVariantAccess);
    ASSERT_EQ(value, zserio::get<UInt16ParamChoice::Tag::valueB>(data));
...
TEST_F(UInt16ParamChoiceTest, valueC)
{
    ...
    data.emplace<UInt16ParamChoice::Tag::valueC>(value);
    ASSERT_THROW(zserio::get<UInt16ParamChoice::Tag::valueA>(data), zserio::BadVariantAccess);
    ASSERT_THROW(zserio::get<UInt16ParamChoice::Tag::valueB>(data), zserio::BadVariantAccess);
    ASSERT_EQ(value, zserio::get<UInt16ParamChoice::Tag::valueC>(data));
...
{
    UInt16ParamChoice data;
    data.emplace<UInt16ParamChoice::Tag::valueB>(2);
    UInt16ParamChoice equalData;
    equalData.emplace<UInt16ParamChoice::Tag::valueB>(2);
    UInt16ParamChoice lessThenData;
    lessThenData.emplace<UInt16ParamChoice::Tag::valueA>(2);
    ...
    lessThenDataViaSelector.emplace<UInt16ParamChoice::Tag::valueB>(2);
...
TEST_F(UInt16ParamChoiceTest, writeRead)
{
    {
        const VariantA value = 99;
        UInt16ParamChoice data(zserio::in_place_index<UInt16ParamChoice::Tag::valueA>, value);
    ...
    {
        const VariantC value = 23456;
        UInt16ParamChoice data(zserio::in_place_index<UInt16ParamChoice::Tag::valueC>, value);
...
TEST_F(UInt16ParamChoiceTest, stdHash)
{
    ...
    UInt16ParamChoice equalData;
    equalData.emplace<UInt16ParamChoice::Tag::valueA>(0);

    UInt16ParamChoice diffData;
    const VariantA value = 99;
    diffData.emplace<UInt16ParamChoice::Tag::valueA>(value);
