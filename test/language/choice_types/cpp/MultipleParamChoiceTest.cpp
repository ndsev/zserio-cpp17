...
TEST_F(MultipleParamChoiceTest, comparisonOperators)
{
    ...
    zserio::View<TestChoice> view(data, FIELD17_SELECTOR, 1, 1);
    zserio::View<TestChoice> equalView(equalData, FIELD17_SELECTOR, 1, 1);
    zserio::View<TestChoice> lessThenView(lessThenData, FIELD17_SELECTOR, 1, 1);
...
{
    {
        ...
        const VectorType<zserio::UInt5> value = {1, 10, 15};
        data.emplace<ChoiceTag::CHOICE_array5>(value);
        zserio::View<TestChoice> view(data, 255, static_cast<uint32_t>(value.size()), 1); // out of range
    ...
    }
    {
        ...
        const VectorType<zserio::UInt5> value = {1, 10, 15};
        data.emplace<ChoiceTag::CHOICE_array5>(value);
        zserio::View<TestChoice> view(
                data, ARRAY5_SELECTOR, std::numeric_limits<uint32_t>::max(), 1); // out of range
        ASSERT_THROW(zserio::detail::validate(view), zserio::OutOfRangeException);
    }
    {
        TestChoice data;
        ...
        data.emplace<ChoiceTag::CHOICE_array5>(value);
        zserio::View<TestChoice> view(
                data, ARRAY5_SELECTOR, static_cast<uint32_t>(value.size()), 16); // out of range
        ASSERT_THROW(zserio::detail::validate(view), zserio::OutOfRangeException);
    }
    {
        TestChoice data;
        const VectorType<zserio::UInt5> value = {1, 10, 255}; // out of range
        data.emplace<ChoiceTag::CHOICE_array5>(value);
    ...
    }
    {
        TestChoice data;
        const VectorType<Data13> value = {
                Data13{VectorType<zserio::Int13>{1, 10, 15}}, Data13{VectorType<zserio::Int13>{1, 10, 15}},
                Data13{VectorType<zserio::Int13>{1, 10, 32767}}, // out of range
        };
        data.emplace<ChoiceTag::CHOICE_array13>(value);
    ...
    {
        TestChoice data;
        const zserio::Int17 value = 131072; // out of range
        data.emplace<ChoiceTag::CHOICE_field17>(value);
    ...
    {
        TestChoice data;
        const zserio::DynInt16<> value = 32767; // out of range
        data.emplace<ChoiceTag::CHOICE_dynBitField>(value);
