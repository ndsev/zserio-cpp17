...
protected:
    ...
    {
        writer.writeVarSize(static_cast<uint32_t>(UnionConstraints::Tag::value8) - 1);
        writer.writeUnsignedBits32(value8, 8);
    }

    static void writeData16(zserio::BitStreamWriter& writer, uint16_t value16)
    {
        writer.writeVarSize(static_cast<uint32_t>(UnionConstraints::Tag::value16) - 1);
...
{
    UnionConstraints data(zserio::in_place_index<UnionConstraints::Tag::value8>, VALUE8_CORRECT_CONSTRAINT);
...
{
    UnionConstraints data(zserio::in_place_index<UnionConstraints::Tag::value16>, VALUE16_CORRECT_CONSTRAINT);
...
{
    UnionConstraints data(zserio::in_place_index<UnionConstraints::Tag::value8>, VALUE8_WRONG_CONSTRAINT);
...
{
    UnionConstraints data(zserio::in_place_index<UnionConstraints::Tag::value16>, VALUE16_WRONG_CONSTRAINT);
