...
TEST(UnionWithParameterTest, case1Allowed)
{
    ...
    data.emplace<ChoiceTag::CHOICE_case1Field>(value);
...
TEST(UnionWithParameterTest, zserioChoiceTag)
{
    ...
    }
    {
        ...
        data.emplace<ChoiceTag::CHOICE_case2Field>(value);
    ...
    }
    {
        ...
        data.emplace<ChoiceTag::CHOICE_case3Field>(value);
        zserio::View view(data, false);
...
TEST(UnionWithParameterTest, case1Field)
{
    ...
    ASSERT_EQ(value, zserio::get<ChoiceTag::CHOICE_case1Field>(data));
...
TEST(UnionWithParameterTest, case2Field)
{
    ...
    ASSERT_THROW(zserio::get<ChoiceTag::CHOICE_case3Field>(data), zserio::BadVariantAccess);
    ASSERT_EQ(value, zserio::get<ChoiceTag::CHOICE_case2Field>(data));
...
TEST(UnionWithParameterTest, case3Field)
{
    ...
    ASSERT_THROW(zserio::get<ChoiceTag::CHOICE_case1Field>(data), zserio::BadVariantAccess);
    ASSERT_THROW(zserio::get<ChoiceTag::CHOICE_case2Field>(data), zserio::BadVariantAccess);
    ASSERT_EQ(value, zserio::get<ChoiceTag::CHOICE_case3Field>(data));
...
{
    TestUnion data;
    data.emplace<ChoiceTag::CHOICE_case3Field>(2);
    TestUnion equalData;
    equalData.emplace<ChoiceTag::CHOICE_case3Field>(2);
    TestUnion lessThenData;
    lessThenData.emplace<ChoiceTag::CHOICE_case3Field>(0);
    ...
    anotherLessThenData.emplace<ChoiceTag::CHOICE_case1Field>(3);
...
TEST(UnionWithParameterTest, bitSizeOf)
{
    {
        TestUnion data;
        data.emplace<ChoiceTag::CHOICE_case1Field>(1);
        zserio::View view(data, true);
        ASSERT_EQ(8 + 32, zserio::detail::bitSizeOf(view));
    }
    {
        TestUnion data;
        data.emplace<ChoiceTag::CHOICE_case2Field>(1);
        zserio::View view(data, false);
        ASSERT_EQ(8 + 16, zserio::detail::bitSizeOf(view));
    }
    {
        TestUnion data;
        data.emplace<ChoiceTag::CHOICE_case3Field>(1);
        zserio::View view(data, false);
...
TEST(UnionWithParameterTest, writeRead)
{
    {
        TestUnion data;
        data.emplace<ChoiceTag::CHOICE_case1Field>(32);
        test_utils::writeReadTest(data, zserio::Bool(true));
    }
    {
        TestUnion data;
        data.emplace<ChoiceTag::CHOICE_case2Field>(16);
        test_utils::writeReadTest(data, zserio::Bool(false));
    }
    {
        TestUnion data;
        data.emplace<ChoiceTag::CHOICE_case3Field>(8);
        test_utils::writeReadTest(data, zserio::Bool(false));
    }
}
