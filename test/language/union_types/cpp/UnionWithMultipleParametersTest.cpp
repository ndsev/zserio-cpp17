...
TEST_F(UnionWithMultipleParametersTest, arrayLength)
{
    ...
    data.emplace<TestUnion::Tag::array5>(value);
...
{
    {
        ...
        data.emplace<TestUnion::Tag::array5>(value);
        zserio::View view(data, static_cast<uint32_t>(value.size()), 1);
        ASSERT_EQ(TestUnion::Tag::array5, view.zserioChoiceTag());
    }
    {
        TestUnion data;
        ...
        data.emplace<TestUnion::Tag::array13>(value);
        zserio::View view(data, static_cast<uint32_t>(value.size()), 1);
        ASSERT_EQ(TestUnion::Tag::array13, view.zserioChoiceTag());
    }
    {
        TestUnion data;
        const zserio::Int17 value = 65535;
        data.emplace<TestUnion::Tag::field17>(value);
        zserio::View view(data, 1, 1);
        ASSERT_EQ(TestUnion::Tag::field17, view.zserioChoiceTag());
    }
    {
        TestUnion data;
...
TEST_F(UnionWithMultipleParametersTest, array5)
{
    ...
    ASSERT_THROW(zserio::get<TestUnion::Tag::field17>(data), zserio::BadVariantAccess);
    ASSERT_THROW(zserio::get<TestUnion::Tag::dynBitField>(data), zserio::BadVariantAccess);
    ASSERT_EQ(value, zserio::get<TestUnion::Tag::array5>(data));
...
TEST_F(UnionWithMultipleParametersTest, array13)
{
    ...
    ASSERT_THROW(zserio::get<TestUnion::Tag::field17>(data), zserio::BadVariantAccess);
    ASSERT_THROW(zserio::get<TestUnion::Tag::dynBitField>(data), zserio::BadVariantAccess);
    ASSERT_EQ(value, zserio::get<TestUnion::Tag::array13>(data));

    zserio::View view(data, static_cast<uint32_t>(value.size()), 1);
    ASSERT_THROW(view.array5(), zserio::BadVariantAccess);
    ASSERT_THROW(view.field17(), zserio::BadVariantAccess);
    ASSERT_THROW(view.dynBitField(), zserio::BadVariantAccess);
    zserio::ArrayView<const Data13, zserio::View<TestUnion>::ZserioArray13ArrayTraits> expectedArray13View(
            value, view);
...
TEST_F(UnionWithMultipleParametersTest, field17)
{
    ...
    ASSERT_THROW(zserio::get<TestUnion::Tag::array13>(data), zserio::BadVariantAccess);
    ASSERT_THROW(zserio::get<TestUnion::Tag::dynBitField>(data), zserio::BadVariantAccess);
    ASSERT_EQ(value, zserio::get<TestUnion::Tag::field17>(data));
...
TEST_F(UnionWithMultipleParametersTest, dynBitField)
{
    ...
    ASSERT_THROW(zserio::get<TestUnion::Tag::array13>(data), zserio::BadVariantAccess);
    ASSERT_THROW(zserio::get<TestUnion::Tag::field17>(data), zserio::BadVariantAccess);
    ASSERT_EQ(value, zserio::get<TestUnion::Tag::dynBitField>(data));
...
{
    TestUnion data;
    data.emplace<TestUnion::Tag::field17>(2);
    TestUnion equalData;
    equalData.emplace<TestUnion::Tag::field17>(2);
    TestUnion lessThenData;
    lessThenData.emplace<TestUnion::Tag::field17>(0);
    ...
    anotherLessThenData.emplace<TestUnion::Tag::array5>(value);
