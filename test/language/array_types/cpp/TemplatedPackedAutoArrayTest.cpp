...
#include "array_types/templated_packed_auto_array/TemplatedPackedAutoArray.h"
#include "gtest/gtest.h"
#include "test_utils/TestUtility.h"

namespace array_types
{
namespace templated_packed_auto_array
{

using AllocatorType = TemplatedPackedAutoArray::allocator_type;
using BytesType = zserio::BasicBytes<AllocatorType>;
using StringType = zserio::BasicString<zserio::RebindAlloc<AllocatorType, char>>;

class TemplatedPackedAutoArrayTest : public ::testing::Test
{
protected:
    TemplatedPackedAutoArray makeData()
    {
        TemplatedPackedAutoArray taa;
...
TEST_F(TemplatedPackedAutoArrayTest, writeReadTest)
{
    auto data = makeData();
    test_utils::writeReadTest(data);
}

TEST_F(TemplatedPackedAutoArrayTest, hashTest)
{
    auto data = makeData();
    EXPECT_EQ(std::hash<TemplatedPackedAutoArray>()(data), static_cast<size_t>(912635957));
}
