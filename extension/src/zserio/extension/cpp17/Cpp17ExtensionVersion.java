...
public final class Cpp17ExtensionVersion
{
    ...
    public static final String CPP17_EXTENSION_VERSION_STRING = "1.1.0";

    /** Expected Zserio core version string. */
    public static final String EXPECTED_ZSERIO_VERSION_STRING = "2.18.1";
    ...
    public static final long CPP17_EXTENSION_VERSION_NUMBER = 1001000;
}
