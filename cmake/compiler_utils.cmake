...
function(compiler_reset_warnings_as_errors)
    compiler_get_warnings_as_errors_setup(WARNINGS_SETUP)
    if (NOT WARNINGS_SETUP STREQUAL "")
...
function(compiler_reset_undefined_sanitizer)
    if ("${CMAKE_CXX_COMPILER_ID}" STREQUAL "Clang")
        compiler_get_undefined_sanitizer_setup(SANITIZER_SETUP)
        if (NOT SANITIZER_SETUP STREQUAL "")
...
function(compiler_reset_debug_iterators)
    if ("${CMAKE_CXX_COMPILER_ID}" STREQUAL "MSVC")
        add_definitions(-D_ITERATOR_DEBUG_LEVEL=0)
    endif ()
endfunction()

function(compiler_set_no_rtti)
    if ("${CMAKE_CXX_COMPILER_ID}" STREQUAL "MSVC")
        string(REGEX REPLACE "/GR" "" NEW_CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS}")
        set(CMAKE_CXX_FLAGS "${NEW_CMAKE_CXX_FLAGS} /GR-" PARENT_SCOPE)
    else ()
