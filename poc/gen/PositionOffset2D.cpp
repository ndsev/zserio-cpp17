...
::zserio::DynInt32 View<PositionOffset2D>::deltaLongitude() const
{
    return m_data.deltaLongitude;
}

::zserio::DynInt32 View<PositionOffset2D>::deltaLatitude() const
{
...
{
    return static_cast<DeltaLongitude>(m_data.deltaLongitude << m_shift_);
}

DeltaLatitude View<PositionOffset2D>::lat() const
{
    return static_cast<DeltaLatitude>(m_data.deltaLatitude << m_shift_);
}
