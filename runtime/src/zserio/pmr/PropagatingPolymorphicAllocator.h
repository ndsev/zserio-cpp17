#ifndef ZSERIO_PMR_PROPAGATING_POLYMORPHIC_ALLOCATOR_H_INC
#define ZSERIO_PMR_PROPAGATING_POLYMORPHIC_ALLOCATOR_H_INC
...
#endif // ZSERIO_PMR_PROPAGATING_POLYMORPHIC_ALLOCATOR_H_INC
