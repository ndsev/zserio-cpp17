...
public:
     ...
     *
     * \param endBitPosition End bit position to calculate the bit position from.
     */
    void setBitPosition(size_t endBitPosition)
    {
        m_bitPosition = endBitPosition;
    }
     ...
     */
    void setEndBitPosition(size_t endBitPosition)
    {
    ...
    size_t getBitPosition() const
    {
        ...
        {
            throw CppRuntimeException("Invalid bit position, read data first!");
        }
    ...
    size_t getBitSize() const
    {
        ...
        {
            throw CppRuntimeException("Invalid bit size, read data first!");
        }
