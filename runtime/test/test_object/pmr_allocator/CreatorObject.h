...
public:
    ...
    using NestedArrayType = ArrayView<const ::test_object::pmr_allocator::CreatorNested, ZserioNestedArrayArrayTraits>;
    using TextArrayType = ArrayView<const ::zserio::pmr::String>;
    using ExternArrayType = ArrayView<const ::zserio::pmr::BitBuffer>;
    using BytesArrayType = ArrayView<const ::zserio::pmr::Bytes>;
    ...
    ::zserio::pmr::Optional<ExternArrayType> externArray() const;
    ::zserio::pmr::Optional<BytesArrayType> bytesArray() const;
...
template <>
struct Reflectable<::test_object::pmr_allocator::CreatorObject, ::std::pmr::polymorphic_allocator<uint8_t>>
{
...
template <>
struct Introspectable<::test_object::pmr_allocator::CreatorObject, ::std::pmr::polymorphic_allocator<uint8_t>>
{
