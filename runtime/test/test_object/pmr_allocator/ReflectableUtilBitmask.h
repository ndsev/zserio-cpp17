...
template <>
struct TypeInfo<::test_object::pmr_allocator::ReflectableUtilBitmask, ::std::pmr::polymorphic_allocator<uint8_t>>
{
...
{
    size_t operator()(const ::test_object::pmr_allocator::ReflectableUtilBitmask& value) const;
};
