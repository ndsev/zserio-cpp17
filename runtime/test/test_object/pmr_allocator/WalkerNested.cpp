...
template <>
void validate(const View<::test_object::pmr_allocator::WalkerNested>& view, ::std::string_view)
{
    validate(view.text(), "'WalkerNested.text'");
}

template <>
BitSize bitSizeOf(const View<::test_object::pmr_allocator::WalkerNested>& view, BitSize bitPosition)
{
...
template <>
void write(BitStreamWriter& writer, const View<::test_object::pmr_allocator::WalkerNested>& view)
{
    auto text_ = view.text();
    write(writer, text_);
}
...
template <>
View<::test_object::pmr_allocator::WalkerNested> read(BitStreamReader& reader, ::test_object::pmr_allocator::WalkerNested& data)
{
