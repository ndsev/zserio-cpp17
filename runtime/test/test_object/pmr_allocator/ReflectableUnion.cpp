...
template <>
void validate(const View<::test_object::pmr_allocator::ReflectableUnion>& view, ::std::string_view)
{
...
View<::test_object::pmr_allocator::ReflectableUnion> read(BitStreamReader& reader, ::test_object::pmr_allocator::ReflectableUnion& data)
{
    ...
    case ::test_object::pmr_allocator::ReflectableUnion::Tag::value32:
        ...
        read(reader, data.get<::test_object::pmr_allocator::ReflectableUnion::Tag::value32>());
        break;
    case ::test_object::pmr_allocator::ReflectableUnion::Tag::valueStr:
        data.emplace<::test_object::pmr_allocator::ReflectableUnion::Tag::valueStr>();
        read(reader, data.get<::test_object::pmr_allocator::ReflectableUnion::Tag::valueStr>());
        break;
    default:
...
const ::zserio::pmr::ITypeInfo& TypeInfo<::test_object::pmr_allocator::ReflectableUnion, ::std::pmr::polymorphic_allocator<uint8_t>>::get()
{
...
size_t hash<::test_object::pmr_allocator::ReflectableUnion>::operator()(const ::test_object::pmr_allocator::ReflectableUnion& value) const
{
...
size_t hash<::zserio::View<::test_object::pmr_allocator::ReflectableUnion>>::operator()(const ::zserio::View<::test_object::pmr_allocator::ReflectableUnion>& view) const
{
    uint32_t result = ::zserio::HASH_SEED;
    switch (view.zserioChoiceTag())
    {
