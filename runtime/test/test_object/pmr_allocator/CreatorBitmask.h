...
template <>
struct TypeInfo<::test_object::pmr_allocator::CreatorBitmask, ::std::pmr::polymorphic_allocator<uint8_t>>
{
...
{
    size_t operator()(const ::test_object::pmr_allocator::CreatorBitmask& value) const;
};
