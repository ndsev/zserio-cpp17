...
{
    return View<::test_object::pmr_allocator::CreatorNested>{
...
{
    return ArrayView<const ::test_object::pmr_allocator::CreatorNested, ZserioNestedArrayArrayTraits>{
...
::zserio::pmr::Optional<View<::test_object::pmr_allocator::CreatorNested>> View<::test_object::pmr_allocator::CreatorObject>::optionalNested() const
{
    ...
    {
        return ::zserio::pmr::Optional<View<::test_object::pmr_allocator::CreatorNested>>{
...
template <>
void validate(const View<::test_object::pmr_allocator::CreatorObject>& view, ::std::string_view)
{
...
View<::test_object::pmr_allocator::CreatorObject> read(BitStreamReader& reader, ::test_object::pmr_allocator::CreatorObject& data)
{
    ...
    (void)readWithTraits<ArrayType::AUTO, View<::test_object::pmr_allocator::CreatorObject>::ZserioNestedArrayArrayTraits>(reader, data.nestedArray, view);
...
::zserio::pmr::IIntrospectableViewConstPtr introspectable(const View<::test_object::pmr_allocator::CreatorObject>& view, const ::std::pmr::polymorphic_allocator<uint8_t>& allocator)
{
    ...
    {
    public:
        Introspectable(const ::zserio::View<::test_object::pmr_allocator::CreatorObject>& view_, const ::std::pmr::polymorphic_allocator<uint8_t>& alloc = {}) :
