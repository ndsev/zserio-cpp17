...
const ::zserio::ITypeInfo& TypeInfo<::test_object::std_allocator::ReflectableBitmask, ::std::allocator<uint8_t>>::get()
{
...
{
    class Introspectable : public ::zserio::detail::IntrospectableViewBase<::test_object::std_allocator::ReflectableBitmask, ::std::allocator<uint8_t>>
    {
    public:
        explicit Introspectable(::test_object::std_allocator::ReflectableBitmask bitmask) :
                ::zserio::detail::IntrospectableViewBase<::test_object::std_allocator::ReflectableBitmask, ::std::allocator<uint8_t>>(
...
size_t hash<::test_object::std_allocator::ReflectableBitmask>::operator()(const ::test_object::std_allocator::ReflectableBitmask& value) const
{
