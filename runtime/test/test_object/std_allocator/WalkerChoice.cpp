...
::zserio::IReflectableDataPtr reflectable(::test_object::std_allocator::WalkerChoice& value, const ::std::allocator<uint8_t>& allocator)
{
    ...
    public:
        ...
        void setField(::std::string_view name, const ::zserio::Any& value) override
        {
            if (name == "value8")
            {
                m_object.emplace<::test_object::std_allocator::WalkerChoice::Tag::value8>(
                        ::zserio::ReflectableUtil::fromAny<::zserio::UInt8>(value));
                return;
            }
            if (name == "value16")
            {
                m_object.emplace<::test_object::std_allocator::WalkerChoice::Tag::value16>(
                        ::zserio::ReflectableUtil::fromAny<::zserio::UInt16>(value));
                return;
            }
            if (name == "value32")
            {
                m_object.emplace<::test_object::std_allocator::WalkerChoice::Tag::value32>(
                        ::zserio::ReflectableUtil::fromAny<::zserio::UInt32>(value));
                return;
            }
            if (name == "value64")
            {
                m_object.emplace<::test_object::std_allocator::WalkerChoice::Tag::value64>(
