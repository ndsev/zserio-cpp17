...
View<::test_object::std_allocator::WalkerUnion> read(BitStreamReader& reader, ::test_object::std_allocator::WalkerUnion& data)
{
    ...
    case ::test_object::std_allocator::WalkerUnion::ChoiceTag::CHOICE_value:
        ...
        break;
    case ::test_object::std_allocator::WalkerUnion::ChoiceTag::CHOICE_text:
        data.emplace<::test_object::std_allocator::WalkerUnion::ChoiceTag::CHOICE_text>();
        read(reader, data.get<::test_object::std_allocator::WalkerUnion::ChoiceTag::CHOICE_text>());
        break;
    case ::test_object::std_allocator::WalkerUnion::ChoiceTag::CHOICE_nestedArray:
        data.emplace<::test_object::std_allocator::WalkerUnion::ChoiceTag::CHOICE_nestedArray>();
...
const ::zserio::ITypeInfo& TypeInfo<::test_object::std_allocator::WalkerUnion, ::std::allocator<uint8_t>>::get()
{
    ...
    static const ::zserio::detail::UnionTypeInfo<AllocatorType> typeInfo = {
        ...
        {
            return ::std::allocate_shared<::zserio::ReflectableDataOwner<::test_object::std_allocator::WalkerUnion>>(allocator);
        },
