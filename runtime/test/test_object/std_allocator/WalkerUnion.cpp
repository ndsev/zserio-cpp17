...
View<::test_object::std_allocator::WalkerUnion>::NestedArrayType View<::test_object::std_allocator::WalkerUnion>::nestedArray() const
{
    return NestedArrayType(get<::test_object::std_allocator::WalkerUnion::Tag::nestedArray>(*m_data));
}
