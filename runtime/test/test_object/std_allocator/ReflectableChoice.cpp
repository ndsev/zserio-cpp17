        ...
        ::test_object::std_allocator::ReflectableEnum param_)
{
    ...
    {
    case ::test_object::std_allocator::ReflectableEnum::VALUE1:
        data.emplace<::test_object::std_allocator::ReflectableChoice::Tag::valueStr>(data.get_allocator());
        read(reader, data.get<::test_object::std_allocator::ReflectableChoice::Tag::valueStr>());
        break;
    case ::test_object::std_allocator::ReflectableEnum::VALUE2:
        data.emplace<::test_object::std_allocator::ReflectableChoice::Tag::value32>();
        read(reader, data.get<::test_object::std_allocator::ReflectableChoice::Tag::value32>());
        break;
    default:
        // empty
        break;
...
::zserio::IReflectableDataPtr reflectable(::test_object::std_allocator::ReflectableChoice& value, const ::std::allocator<uint8_t>& allocator)
{
    ...
    public:
        ...
        void setField(::std::string_view name, const ::zserio::Any& value) override
        {
            if (name == "valueStr")
            {
                m_object.emplace<::test_object::std_allocator::ReflectableChoice::Tag::valueStr>(
                        ::zserio::ReflectableUtil::fromAny<::zserio::String>(value));
                return;
            }
            if (name == "value32")
            {
                m_object.emplace<::test_object::std_allocator::ReflectableChoice::Tag::value32>(
        ...
        ::zserio::IReflectableDataPtr createField(::std::string_view name) override
        {
            if (name == "valueStr")
            {
                m_object.emplace<::test_object::std_allocator::ReflectableChoice::Tag::valueStr>(get_allocator());
