...
const ::zserio::ITypeInfo& TypeInfo<::test_object::std_allocator::ReflectableUtilChoice, ::std::allocator<uint8_t>>::get()
{
    ...
    static const ::zserio::detail::ChoiceTypeInfo<AllocatorType> typeInfo = {
        ...
        {
            return ::std::allocate_shared<::zserio::ReflectableDataOwner<::test_object::std_allocator::ReflectableUtilChoice>>(allocator);
        },
...
::zserio::IIntrospectableViewConstPtr introspectable(const View<::test_object::std_allocator::ReflectableUtilChoice>& view, const ::std::allocator<uint8_t>& allocator)
{
    ...
    {
    public:
        Introspectable(const ::zserio::View<::test_object::std_allocator::ReflectableUtilChoice>& view_, const ::std::allocator<uint8_t>& alloc = {}) :
