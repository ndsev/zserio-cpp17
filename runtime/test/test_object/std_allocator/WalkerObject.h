...
{
public:
    using UnionArrayType = ArrayView<const ::test_object::std_allocator::WalkerUnion>;
    using OptionalUnionArrayType = ArrayView<const ::test_object::std_allocator::WalkerUnion>;
    ...
    ::zserio::Optional<OptionalUnionArrayType> optionalUnionArray() const;
