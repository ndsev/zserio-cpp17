...
public:
    ...
    using NestedArrayType = ArrayView<const ::test_object::std_allocator::CreatorNested, ZserioNestedArrayArrayTraits>;
    using TextArrayType = ArrayView<const ::zserio::String>;
    using ExternArrayType = ArrayView<const ::zserio::BitBuffer>;
    using BytesArrayType = ArrayView<const ::zserio::Bytes>;
    ...
    ::zserio::Optional<ExternArrayType> externArray() const;
    ::zserio::Optional<BytesArrayType> bytesArray() const;
