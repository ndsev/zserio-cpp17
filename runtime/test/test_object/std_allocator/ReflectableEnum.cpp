...
{
    class Introspectable : public ::zserio::detail::IntrospectableViewBase<::test_object::std_allocator::ReflectableEnum, ::std::allocator<uint8_t>>
    {
    public:
        explicit Introspectable(::test_object::std_allocator::ReflectableEnum value) :
                ::zserio::detail::IntrospectableViewBase<::test_object::std_allocator::ReflectableEnum, ::std::allocator<uint8_t>>(
