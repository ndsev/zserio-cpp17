...
View<::test_object::std_allocator::WalkerObject>::UnionArrayType View<::test_object::std_allocator::WalkerObject>::unionArray() const
{
    return UnionArrayType(m_data->unionArray);
}

::zserio::Optional<View<::test_object::std_allocator::WalkerObject>::OptionalUnionArrayType> View<::test_object::std_allocator::WalkerObject>::optionalUnionArray() const
{
    if (m_data->optionalUnionArray.has_value())
    {
        return ::zserio::Optional<OptionalUnionArrayType>(::std::in_place, m_data->optionalUnionArray.get_allocator(), *m_data->optionalUnionArray);
    }
    else
    {
        return ::zserio::Optional<OptionalUnionArrayType>(::std::nullopt, m_data->optionalUnionArray.get_allocator());
    }
}
