...
const ::zserio::ITypeInfo& TypeInfo<::test_object::std_allocator::DebugStringParamObject, ::std::allocator<uint8_t>>::get()
{
    ...
    static const ::zserio::detail::StructTypeInfo<AllocatorType> typeInfo = {
        ...
        {
            return ::std::allocate_shared<::zserio::ReflectableDataOwner<::test_object::std_allocator::DebugStringParamObject>>(allocator);
        },
...
::zserio::IIntrospectableViewConstPtr introspectable(const View<::test_object::std_allocator::DebugStringParamObject>& view, const ::std::allocator<uint8_t>& allocator)
{
    ...
    {
    public:
        explicit Introspectable(const ::zserio::View<::test_object::std_allocator::DebugStringParamObject>& view_, const ::std::allocator<uint8_t>& alloc = {}) :
