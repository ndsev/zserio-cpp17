...
{
    class Introspectable : public ::zserio::SimpleIntrospectableViewBase<::test_object::std_allocator::CreatorEnum, ::std::allocator<uint8_t>>
    {
    public:
        explicit Introspectable(::test_object::std_allocator::CreatorEnum value) :
                ::zserio::SimpleIntrospectableViewBase<::test_object::std_allocator::CreatorEnum, ::std::allocator<uint8_t>>(
