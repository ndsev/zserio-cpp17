...
{
    class Introspectable : public ::zserio::SimpleIntrospectableViewBase<::test_object::std_allocator::CreatorUnsignedEnum, ::std::allocator<uint8_t>>
    {
    public:
        explicit Introspectable(::test_object::std_allocator::CreatorUnsignedEnum value) :
                ::zserio::SimpleIntrospectableViewBase<::test_object::std_allocator::CreatorUnsignedEnum, ::std::allocator<uint8_t>>(
