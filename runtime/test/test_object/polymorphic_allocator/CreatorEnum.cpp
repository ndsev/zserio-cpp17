...
{
    class Introspectable : public ::zserio::detail::IntrospectableViewBase<::test_object::polymorphic_allocator::CreatorEnum, ::zserio::pmr::PropagatingPolymorphicAllocator<uint8_t>>
    {
    public:
        explicit Introspectable(::test_object::polymorphic_allocator::CreatorEnum value) :
                ::zserio::detail::IntrospectableViewBase<::test_object::polymorphic_allocator::CreatorEnum, ::zserio::pmr::PropagatingPolymorphicAllocator<uint8_t>>(
