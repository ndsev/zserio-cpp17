...
View<::test_object::polymorphic_allocator::ReflectableNested>::View(const ::test_object::polymorphic_allocator::ReflectableNested& data,
...
::zserio::Int31 View<::test_object::polymorphic_allocator::ReflectableNested>::dummyParam() const
{
    return m_dummyParam_;
}

::std::string_view View<::test_object::polymorphic_allocator::ReflectableNested>::stringParam() const
{
    return m_stringParam_;
}

::zserio::UInt31 View<::test_object::polymorphic_allocator::ReflectableNested>::value() const
{
    return m_data->value;
}

::zserio::UInt31 View<::test_object::polymorphic_allocator::ReflectableNested>::getValue() const
{
    return static_cast<::zserio::UInt31::ValueType>(value());
}

const ::test_object::polymorphic_allocator::ReflectableNested& View<::test_object::polymorphic_allocator::ReflectableNested>::zserioData() const
{
    return *m_data;
}
...
template <>
void validate(const View<::test_object::polymorphic_allocator::ReflectableNested>& view, ::std::string_view)
{
...
{
    View<::test_object::polymorphic_allocator::ReflectableNested> view(data,
            dummyParam_,
            stringParam_);
...
const ::zserio::pmr::ITypeInfo& TypeInfo<::test_object::polymorphic_allocator::ReflectableNested, ::zserio::pmr::PropagatingPolymorphicAllocator<uint8_t>>::get()
{
    ...
    static const ::std::array<::zserio::BasicFieldInfo<AllocatorType>, 1> fields = {
        ::zserio::BasicFieldInfo<AllocatorType>{
            "value", // schemaName
            ::zserio::typeInfo<::zserio::UInt31, ::zserio::pmr::PropagatingPolymorphicAllocator<uint8_t>>(), // typeInfo
            {}, // typeArguments
            false, // isExtended
            {}, // alignment
            {}, // offset
    ...
    static const ::std::array<::zserio::BasicParameterInfo<AllocatorType>, 2> parameters = {
        ::zserio::BasicParameterInfo<AllocatorType>{
            "dummyParam",
            ::zserio::typeInfo<::zserio::Int31, ::zserio::pmr::PropagatingPolymorphicAllocator<uint8_t>>()
        },
        ::zserio::BasicParameterInfo<AllocatorType>{
            "stringParam",
            ::zserio::typeInfo<::zserio::pmr::String, ::zserio::pmr::PropagatingPolymorphicAllocator<uint8_t>>()
        }
    };
    ...
    static const ::std::array<::zserio::BasicFunctionInfo<AllocatorType>, 1> functions = {
        ::zserio::BasicFunctionInfo<AllocatorType>{
            "getValue",
            ::zserio::typeInfo<::zserio::UInt31, ::zserio::pmr::PropagatingPolymorphicAllocator<uint8_t>>(),
            "value()"
        }
    };
    ...
    static const ::zserio::detail::StructTypeInfo<AllocatorType> typeInfo = {
        ...
        {
            return ::std::allocate_shared<::zserio::detail::ReflectableDataOwner<::test_object::polymorphic_allocator::ReflectableNested>>(allocator, allocator);
        },
...
::zserio::pmr::IReflectableDataConstPtr reflectable(
        const ::test_object::polymorphic_allocator::ReflectableNested& value, const ::zserio::pmr::PropagatingPolymorphicAllocator<uint8_t>& allocator)
{
    ...
    public:
        ...
        explicit Reflectable(const ::test_object::polymorphic_allocator::ReflectableNested& object, const ::zserio::pmr::PropagatingPolymorphicAllocator<uint8_t>& alloc) :
                ::zserio::detail::ReflectableDataConstAllocatorHolderBase<::zserio::pmr::PropagatingPolymorphicAllocator<uint8_t>>(typeInfo<::test_object::polymorphic_allocator::ReflectableNested>(), alloc),
                m_object(object)
        {}
...
::zserio::pmr::IReflectableDataPtr reflectable(
        ::test_object::polymorphic_allocator::ReflectableNested& value, const ::zserio::pmr::PropagatingPolymorphicAllocator<uint8_t>& allocator)
{
    ...
    public:
        ...
        explicit Reflectable(::test_object::polymorphic_allocator::ReflectableNested& object, const ::zserio::pmr::PropagatingPolymorphicAllocator<uint8_t>& alloc) :
                ::zserio::detail::ReflectableDataAllocatorHolderBase<::zserio::pmr::PropagatingPolymorphicAllocator<uint8_t>>(typeInfo<::test_object::polymorphic_allocator::ReflectableNested>(), alloc),
                m_object(object)
        {}
...
{
    class Introspectable : public ::zserio::detail::CompoundIntrospectableViewBase<::test_object::polymorphic_allocator::ReflectableNested, ::zserio::pmr::PropagatingPolymorphicAllocator<uint8_t>>
    {
    public:
        Introspectable(const ::zserio::View<::test_object::polymorphic_allocator::ReflectableNested>& view_, const ::zserio::pmr::PropagatingPolymorphicAllocator<uint8_t>& allocator) :
                ::zserio::detail::CompoundIntrospectableViewBase<::test_object::polymorphic_allocator::ReflectableNested, ::zserio::pmr::PropagatingPolymorphicAllocator<uint8_t>>(
                        view_, allocator)
        {}
...
size_t hash<::test_object::polymorphic_allocator::ReflectableNested>::operator()(const ::test_object::polymorphic_allocator::ReflectableNested& data) const
{
...
size_t hash<::zserio::View<::test_object::polymorphic_allocator::ReflectableNested>>::operator()(const ::zserio::View<::test_object::polymorphic_allocator::ReflectableNested>& view) const
{
    uint32_t result = ::zserio::HASH_SEED;
