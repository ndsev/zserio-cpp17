...
View<::test_object::polymorphic_allocator::CreatorNested> View<::test_object::polymorphic_allocator::CreatorObject>::ZserioNestedArrayArrayTraits::at(const OwnerType& owner,
        const ::test_object::polymorphic_allocator::CreatorNested& element, size_t)
{
    return View<::test_object::polymorphic_allocator::CreatorNested>(element, ::zserio::UInt32(static_cast<::zserio::UInt32::ValueType>(owner.value())));
}

void View<::test_object::polymorphic_allocator::CreatorObject>::ZserioNestedArrayArrayTraits::read(BitStreamReader& reader, const OwnerType& owner,
...
View<::test_object::polymorphic_allocator::CreatorObject>::View(const ::test_object::polymorphic_allocator::CreatorObject& data) noexcept :
        m_data(&data)
{}

View<::test_object::polymorphic_allocator::CreatorObject>::View(const ::test_object::polymorphic_allocator::CreatorObject& data,
        const View&) noexcept :
        m_data(&data)
{}

::zserio::UInt32 View<::test_object::polymorphic_allocator::CreatorObject>::value() const
{
    return m_data->value;
}

View<::test_object::polymorphic_allocator::CreatorNested> View<::test_object::polymorphic_allocator::CreatorObject>::nested() const
{
    return View<::test_object::polymorphic_allocator::CreatorNested>{
            m_data->nested, ::zserio::UInt32(static_cast<::zserio::UInt32::ValueType>(value()))};
}

::std::string_view View<::test_object::polymorphic_allocator::CreatorObject>::text() const
{
    return ::std::string_view{
            m_data->text};
}

Array<::zserio::pmr::Vector<::test_object::polymorphic_allocator::CreatorNested>, ArrayType::AUTO, ::zserio::ArrayStorage::IMMUTABLE, View<::test_object::polymorphic_allocator::CreatorObject>::ZserioNestedArrayArrayTraits> View<::test_object::polymorphic_allocator::CreatorObject>::nestedArray() const
{
    return Array<::zserio::pmr::Vector<::test_object::polymorphic_allocator::CreatorNested>, ArrayType::AUTO, ::zserio::ArrayStorage::IMMUTABLE, ZserioNestedArrayArrayTraits>{
            m_data->nestedArray, *this};
}

Array<::zserio::pmr::Vector<::zserio::pmr::String>, ArrayType::AUTO> View<::test_object::polymorphic_allocator::CreatorObject>::textArray() const
{
    return Array<::zserio::pmr::Vector<::zserio::pmr::String>, ArrayType::AUTO>{
            m_data->textArray};
}

::zserio::pmr::Optional<Array<::zserio::pmr::Vector<::zserio::pmr::BitBuffer>, ArrayType::AUTO>> View<::test_object::polymorphic_allocator::CreatorObject>::externArray() const
{
    if (m_data->externArray.has_value())
    {
        return ::zserio::pmr::Optional<Array<::zserio::pmr::Vector<::zserio::pmr::BitBuffer>, ArrayType::AUTO>>{
                ::std::in_place, m_data->externArray.get_allocator(), *m_data->externArray};
    }
    else
    {
        return ::zserio::pmr::Optional<Array<::zserio::pmr::Vector<::zserio::pmr::BitBuffer>, ArrayType::AUTO>>(::std::nullopt, m_data->externArray.get_allocator());
    }
}

::zserio::pmr::Optional<Array<::zserio::pmr::Vector<::zserio::pmr::Bytes>, ArrayType::AUTO>> View<::test_object::polymorphic_allocator::CreatorObject>::bytesArray() const
{
    if (m_data->bytesArray.has_value())
    {
        return ::zserio::pmr::Optional<Array<::zserio::pmr::Vector<::zserio::pmr::Bytes>, ArrayType::AUTO>>{
                ::std::in_place, m_data->bytesArray.get_allocator(), *m_data->bytesArray};
    }
    else
    {
        return ::zserio::pmr::Optional<Array<::zserio::pmr::Vector<::zserio::pmr::Bytes>, ArrayType::AUTO>>(::std::nullopt, m_data->bytesArray.get_allocator());
    }
}

::zserio::pmr::Optional<::zserio::Bool> View<::test_object::polymorphic_allocator::CreatorObject>::optionalBool() const
{
    return m_data->optionalBool;
}

::zserio::pmr::Optional<View<::test_object::polymorphic_allocator::CreatorNested>> View<::test_object::polymorphic_allocator::CreatorObject>::optionalNested() const
{
    if (m_data->optionalNested.has_value())
    {
        return ::zserio::pmr::Optional<View<::test_object::polymorphic_allocator::CreatorNested>>{
    ...
    {
        return ::zserio::pmr::Optional<View<::test_object::polymorphic_allocator::CreatorNested>>(::std::nullopt, m_data->optionalNested.get_allocator());
    }
}

const ::test_object::polymorphic_allocator::CreatorObject& View<::test_object::polymorphic_allocator::CreatorObject>::zserioData() const
{
    return *m_data;
}
...
template <>
void validate(const View<::test_object::polymorphic_allocator::CreatorObject>& view, ::std::string_view)
{
...
{
    View<::test_object::polymorphic_allocator::CreatorObject> view(data);
    ...
    (void)read<Array<::zserio::pmr::Vector<::test_object::polymorphic_allocator::CreatorNested>, ArrayType::AUTO, ::zserio::ArrayStorage::IMMUTABLE, View<::test_object::polymorphic_allocator::CreatorObject>::ZserioNestedArrayArrayTraits>>(reader, data.nestedArray, view);
    read<Array<::zserio::pmr::Vector<::zserio::pmr::String>, ArrayType::AUTO>>(reader, data.textArray);
    if (reader.readBool())
    {
        data.externArray.emplace(data.externArray.get_allocator());
        read<Array<::zserio::pmr::Vector<::zserio::pmr::BitBuffer>, ArrayType::AUTO>>(reader, *data.externArray);
    }
    if (reader.readBool())
    {
        data.bytesArray.emplace(data.bytesArray.get_allocator());
        read<Array<::zserio::pmr::Vector<::zserio::pmr::Bytes>, ArrayType::AUTO>>(reader, *data.bytesArray);
    }
    if (reader.readBool())
    {
...
const ::zserio::pmr::ITypeInfo& TypeInfo<::test_object::polymorphic_allocator::CreatorObject, ::zserio::pmr::PropagatingPolymorphicAllocator<uint8_t>>::get()
{
    ...
    static const ::std::array<::zserio::BasicFieldInfo<AllocatorType>, 9> fields = {
        ...
        ::zserio::BasicFieldInfo<AllocatorType>{
            "nested", // schemaName
            ::zserio::typeInfo<::test_object::polymorphic_allocator::CreatorNested, ::zserio::pmr::PropagatingPolymorphicAllocator<uint8_t>>(), // typeInfo
        ...
        ::zserio::BasicFieldInfo<AllocatorType>{
            ...
            ::zserio::typeInfo<::zserio::Bool, ::zserio::pmr::PropagatingPolymorphicAllocator<uint8_t>>(), // typeInfo
            {}, // typeArguments
            false, // isExtended
            {}, // alignment
            {}, // offset
    ...
    static const ::zserio::detail::StructTypeInfo<AllocatorType> typeInfo = {
        "test_object.polymorphic_allocator.CreatorObject",
        [](const AllocatorType& allocator) -> ::zserio::IReflectableDataPtr
        {
            return std::allocate_shared<::zserio::ReflectableOwner<::test_object::polymorphic_allocator::CreatorObject>>(allocator, allocator);
        },
...
::zserio::IReflectableDataConstPtr reflectable(
        const ::test_object::polymorphic_allocator::CreatorObject& object, const ::zserio::pmr::PropagatingPolymorphicAllocator<uint8_t>& allocator)
{
    ...
    public:
        ...
        explicit Reflectable(const ::test_object::polymorphic_allocator::CreatorObject& object_, const ::zserio::pmr::PropagatingPolymorphicAllocator<uint8_t>& alloc) :
                ::zserio::ReflectableConstAllocatorHolderBase<::zserio::pmr::PropagatingPolymorphicAllocator<uint8_t>>(typeInfo<::test_object::polymorphic_allocator::CreatorObject>(), alloc),
                m_object(object_)
        {}
...
::zserio::IReflectableDataPtr reflectable(
        ::test_object::polymorphic_allocator::CreatorObject& object, const ::zserio::pmr::PropagatingPolymorphicAllocator<uint8_t>& allocator)
{
    class Reflectable : public ::zserio::ReflectableAllocatorHolderBase<::zserio::pmr::PropagatingPolymorphicAllocator<uint8_t>>
    {
    public:
        explicit Reflectable(::test_object::polymorphic_allocator::CreatorObject& object_, const ::zserio::pmr::PropagatingPolymorphicAllocator<uint8_t>& alloc) :
                ::zserio::ReflectableAllocatorHolderBase<::zserio::pmr::PropagatingPolymorphicAllocator<uint8_t>>(typeInfo<::test_object::polymorphic_allocator::CreatorObject>(), alloc),
                m_object(object_)
        {}
        ...
        void setField(::std::string_view name, const ::zserio::pmr::Any& value) override
        {
            ...
            {
                m_object.nested =
                        value.get<::test_object::polymorphic_allocator::CreatorNested>();
                return;
            }
            if (name == "text")
            {
            ...
            if (name == "nestedArray")
            {
                m_object.nestedArray =
                        value.get<::zserio::pmr::Vector<::test_object::polymorphic_allocator::CreatorNested>>();
                return;
            }
            if (name == "textArray")
            {
                m_object.textArray =
                        value.get<::zserio::pmr::Vector<::zserio::pmr::String>>();
                return;
            }
            if (name == "externArray")
            {
                ...
                m_object.externArray =
                        value.get<::zserio::pmr::Vector<::zserio::pmr::BitBuffer>>();
                return;
            }
            if (name == "bytesArray")
            {
                ...
                m_object.bytesArray =
                        value.get<::zserio::pmr::Vector<::zserio::pmr::Bytes>>();
                return;
            }
            if (name == "optionalBool")
            {
        ...
        ::zserio::IReflectableDataPtr createField(::std::string_view name) override
        {
            ...
            {
                m_object.nested =
                        ::test_object::polymorphic_allocator::CreatorNested(get_allocator());
                return ::zserio::reflectable(m_object.nested, get_allocator());
            }
            if (name == "text")
            {
            ...
            {
                m_object.nestedArray =
                        ::zserio::pmr::Vector<::test_object::polymorphic_allocator::CreatorNested>(get_allocator());
                return ::zserio::reflectableArray(m_object.nestedArray, get_allocator());
            }
            if (name == "textArray")
            {
                m_object.textArray =
                        ::zserio::pmr::Vector<::zserio::pmr::String>(get_allocator());
                return ::zserio::reflectableArray(m_object.textArray, get_allocator());
            }
            if (name == "externArray")
            {
                m_object.externArray =
                        ::zserio::pmr::Vector<::zserio::pmr::BitBuffer>(get_allocator());
                return ::zserio::reflectableArray(*m_object.externArray, get_allocator());
            }
            if (name == "bytesArray")
            {
                m_object.bytesArray =
                        ::zserio::pmr::Vector<::zserio::pmr::Bytes>(get_allocator());
                return ::zserio::reflectableArray(*m_object.bytesArray, get_allocator());
            }
            if (name == "optionalBool")
            {
...
size_t hash<::test_object::polymorphic_allocator::CreatorObject>::operator()(const ::test_object::polymorphic_allocator::CreatorObject& data) const
{
...
size_t hash<::zserio::View<::test_object::polymorphic_allocator::CreatorObject>>::operator()(const ::zserio::View<::test_object::polymorphic_allocator::CreatorObject>& view) const
{
    uint32_t result = ::zserio::HASH_SEED;
