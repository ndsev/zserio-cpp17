...
{
    class Introspectable : public ::zserio::detail::IntrospectableViewBase<::test_object::polymorphic_allocator::ReflectableBitmask, ::zserio::pmr::PropagatingPolymorphicAllocator<uint8_t>>
    {
    public:
        explicit Introspectable(::test_object::polymorphic_allocator::ReflectableBitmask bitmask) :
                ::zserio::detail::IntrospectableViewBase<::test_object::polymorphic_allocator::ReflectableBitmask, ::zserio::pmr::PropagatingPolymorphicAllocator<uint8_t>>(
