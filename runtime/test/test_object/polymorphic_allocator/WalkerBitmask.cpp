...
{
    class Introspectable : public ::zserio::detail::IntrospectableViewBase<::test_object::polymorphic_allocator::WalkerBitmask, ::zserio::pmr::PropagatingPolymorphicAllocator<uint8_t>>
    {
    public:
        explicit Introspectable(::test_object::polymorphic_allocator::WalkerBitmask bitmask) :
                ::zserio::detail::IntrospectableViewBase<::test_object::polymorphic_allocator::WalkerBitmask, ::zserio::pmr::PropagatingPolymorphicAllocator<uint8_t>>(
