...
{
    return get<::test_object::polymorphic_allocator::ReflectableUtilUnion::Tag::reflectableUtilEnum>(*m_data);
}
...
{
    return get<::test_object::polymorphic_allocator::ReflectableUtilUnion::Tag::reflectableUtilBitmask>(*m_data);
}
...
{
    return View<::test_object::polymorphic_allocator::ReflectableUtilObject>{get<::test_object::polymorphic_allocator::ReflectableUtilUnion::Tag::reflectableUtilObject>(*m_data)};
}

::test_object::polymorphic_allocator::ReflectableUtilUnion::Tag View<::test_object::polymorphic_allocator::ReflectableUtilUnion>::zserioChoiceTag() const
{
    return m_data->index();
}
...
bool operator==(const View<::test_object::polymorphic_allocator::ReflectableUtilUnion>& lhs, const View<::test_object::polymorphic_allocator::ReflectableUtilUnion>& rhs)
{
    ...
    {
    case ::test_object::polymorphic_allocator::ReflectableUtilUnion::Tag::reflectableUtilEnum:
        return (lhs.reflectableUtilEnum() == rhs.reflectableUtilEnum());
    case ::test_object::polymorphic_allocator::ReflectableUtilUnion::Tag::reflectableUtilBitmask:
        return (lhs.reflectableUtilBitmask() == rhs.reflectableUtilBitmask());
    case ::test_object::polymorphic_allocator::ReflectableUtilUnion::Tag::reflectableUtilObject:
...
void validate(const View<::test_object::polymorphic_allocator::ReflectableUtilUnion>& view, ::std::string_view)
{
    ...
    case ::test_object::polymorphic_allocator::ReflectableUtilUnion::Tag::reflectableUtilObject:
        ...
        break;
    default:
        throw UnionCaseException("No case set in union '::test_object::polymorphic_allocator::ReflectableUtilUnion'!");
    }
}
...
View<::test_object::polymorphic_allocator::ReflectableUtilUnion> read(BitStreamReader& reader, ::test_object::polymorphic_allocator::ReflectableUtilUnion& data)
{
    ...
    switch (static_cast<::test_object::polymorphic_allocator::ReflectableUtilUnion::Tag>(choiceTag + 1))
    {
    case ::test_object::polymorphic_allocator::ReflectableUtilUnion::Tag::reflectableUtilEnum:
        data.emplace<::test_object::polymorphic_allocator::ReflectableUtilUnion::Tag::reflectableUtilEnum>();
        read(reader, data.get<::test_object::polymorphic_allocator::ReflectableUtilUnion::Tag::reflectableUtilEnum>());
        break;
    case ::test_object::polymorphic_allocator::ReflectableUtilUnion::Tag::reflectableUtilBitmask:
        data.emplace<::test_object::polymorphic_allocator::ReflectableUtilUnion::Tag::reflectableUtilBitmask>();
        read(reader, data.get<::test_object::polymorphic_allocator::ReflectableUtilUnion::Tag::reflectableUtilBitmask>());
        break;
    case ::test_object::polymorphic_allocator::ReflectableUtilUnion::Tag::reflectableUtilObject:
        data.emplace<::test_object::polymorphic_allocator::ReflectableUtilUnion::Tag::reflectableUtilObject>(data.get_allocator());
        (void)read(reader, data.get<::test_object::polymorphic_allocator::ReflectableUtilUnion::Tag::reflectableUtilObject>());
        break;
    default:
        throw UnionCaseException("Unexpected choice tag during read of union '::test_object::polymorphic_allocator::ReflectableUtilUnion'!");
    }
...
const ::zserio::pmr::ITypeInfo& TypeInfo<::test_object::polymorphic_allocator::ReflectableUtilUnion, ::zserio::pmr::PropagatingPolymorphicAllocator<uint8_t>>::get()
{
    ...
    static const ::zserio::detail::UnionTypeInfo<AllocatorType> typeInfo = {
        ...
        {
            return ::std::allocate_shared<::zserio::detail::ReflectableDataOwner<::test_object::polymorphic_allocator::ReflectableUtilUnion>>(allocator, allocator);
        },
...
::zserio::pmr::IReflectableDataConstPtr reflectable(const ::test_object::polymorphic_allocator::ReflectableUtilUnion& value, const ::zserio::pmr::PropagatingPolymorphicAllocator<uint8_t>& allocator)
{
    ...
    public:
        ...
        explicit Reflectable(const ::test_object::polymorphic_allocator::ReflectableUtilUnion& object, const ::zserio::pmr::PropagatingPolymorphicAllocator<uint8_t>& alloc) :
                ::zserio::detail::ReflectableDataConstAllocatorHolderBase<::zserio::pmr::PropagatingPolymorphicAllocator<uint8_t>>(typeInfo<::test_object::polymorphic_allocator::ReflectableUtilUnion>(), alloc),
                m_object(object)
        {}
        ...
        ::zserio::pmr::IReflectableDataConstPtr getField(::std::string_view name) const override
        {
            if (name == "reflectableUtilEnum")
            {
                return ::zserio::reflectable(
                        get<::test_object::polymorphic_allocator::ReflectableUtilUnion::Tag::reflectableUtilEnum>(m_object), get_allocator());
            }
            if (name == "reflectableUtilBitmask")
            {
                return ::zserio::reflectable(
                        get<::test_object::polymorphic_allocator::ReflectableUtilUnion::Tag::reflectableUtilBitmask>(m_object), get_allocator());
            }
            if (name == "reflectableUtilObject")
            {
                return ::zserio::reflectable(
                        get<::test_object::polymorphic_allocator::ReflectableUtilUnion::Tag::reflectableUtilObject>(m_object), get_allocator());
            }
...
::zserio::pmr::IReflectableDataPtr reflectable(::test_object::polymorphic_allocator::ReflectableUtilUnion& value, const ::zserio::pmr::PropagatingPolymorphicAllocator<uint8_t>& allocator)
{
    ...
    public:
        ...
        explicit Reflectable(::test_object::polymorphic_allocator::ReflectableUtilUnion& object, const ::zserio::pmr::PropagatingPolymorphicAllocator<uint8_t>& alloc) :
                ::zserio::detail::ReflectableDataAllocatorHolderBase<::zserio::pmr::PropagatingPolymorphicAllocator<uint8_t>>(typeInfo<::test_object::polymorphic_allocator::ReflectableUtilUnion>(), alloc),
                m_object(object)
        {}
        ...
        void setField(::std::string_view name, const ::zserio::pmr::Any& value) override
        {
            if (name == "reflectableUtilEnum")
            {
                m_object.emplace<::test_object::polymorphic_allocator::ReflectableUtilUnion::Tag::reflectableUtilEnum>(
                        ::zserio::ReflectableUtil::fromAny<::test_object::polymorphic_allocator::ReflectableUtilEnum>(value));
                return;
            }
            if (name == "reflectableUtilBitmask")
            {
                m_object.emplace<::test_object::polymorphic_allocator::ReflectableUtilUnion::Tag::reflectableUtilBitmask>(
                        ::zserio::ReflectableUtil::fromAny<::test_object::polymorphic_allocator::ReflectableUtilBitmask>(value));
                return;
            }
            if (name == "reflectableUtilObject")
            {
                m_object.emplace<::test_object::polymorphic_allocator::ReflectableUtilUnion::Tag::reflectableUtilObject>(
                        ::zserio::ReflectableUtil::fromAny<::test_object::polymorphic_allocator::ReflectableUtilObject>(value));
                return;
            }
            throw ::zserio::CppRuntimeException("Field '") << name << "' doesn't exist in 'ReflectableUtilUnion'!";
        }
        ...
        ::zserio::pmr::IReflectableDataPtr createField(::std::string_view name) override
        {
            ...
            {
                m_object.emplace<::test_object::polymorphic_allocator::ReflectableUtilUnion::Tag::reflectableUtilEnum>();
                return ::zserio::reflectable(get<::test_object::polymorphic_allocator::ReflectableUtilUnion::Tag::reflectableUtilEnum>(m_object), get_allocator());
            }
            if (name == "reflectableUtilBitmask")
            {
                m_object.emplace<::test_object::polymorphic_allocator::ReflectableUtilUnion::Tag::reflectableUtilBitmask>();
                return ::zserio::reflectable(get<::test_object::polymorphic_allocator::ReflectableUtilUnion::Tag::reflectableUtilBitmask>(m_object), get_allocator());
            }
            if (name == "reflectableUtilObject")
            {
                m_object.emplace<::test_object::polymorphic_allocator::ReflectableUtilUnion::Tag::reflectableUtilObject>(get_allocator());
                return ::zserio::reflectable(get<::test_object::polymorphic_allocator::ReflectableUtilUnion::Tag::reflectableUtilObject>(m_object), get_allocator());
            }
            throw ::zserio::CppRuntimeException("Field '") << name << "' doesn't exist in 'ReflectableUtilUnion'!";
        }
...
{
    class Introspectable : public ::zserio::detail::CompoundIntrospectableViewBase<::test_object::polymorphic_allocator::ReflectableUtilUnion, ::zserio::pmr::PropagatingPolymorphicAllocator<uint8_t>>
    {
    public:
        Introspectable(const ::zserio::View<::test_object::polymorphic_allocator::ReflectableUtilUnion>& view_, const ::zserio::pmr::PropagatingPolymorphicAllocator<uint8_t>& allocator) :
                ::zserio::detail::CompoundIntrospectableViewBase<::test_object::polymorphic_allocator::ReflectableUtilUnion, ::zserio::pmr::PropagatingPolymorphicAllocator<uint8_t>>(
                        view_, allocator)
        {}
