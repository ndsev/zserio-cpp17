...
bool operator==(const ::test_object::polymorphic_allocator::WalkerChoice& lhs, const ::test_object::polymorphic_allocator::WalkerChoice& rhs)
{
    return static_cast<const ::test_object::polymorphic_allocator::WalkerChoice::Base&>(lhs) == static_cast<const ::test_object::polymorphic_allocator::WalkerChoice::Base&>(rhs);
}
...
View<::test_object::polymorphic_allocator::WalkerChoice>::View(const ::test_object::polymorphic_allocator::WalkerChoice& data,
...
::zserio::UInt8 View<::test_object::polymorphic_allocator::WalkerChoice>::selector() const
{
    return m_selector_;
}
...
const ::test_object::polymorphic_allocator::WalkerChoice& View<::test_object::polymorphic_allocator::WalkerChoice>::zserioData() const
{
    return *m_data;
}

bool operator==(const View<::test_object::polymorphic_allocator::WalkerChoice>& lhs, const View<::test_object::polymorphic_allocator::WalkerChoice>& rhs)
{
...
template <>
void validate(const View<::test_object::polymorphic_allocator::WalkerChoice>& view, ::std::string_view)
{
...
template <>
BitSize bitSizeOf(const View<::test_object::polymorphic_allocator::WalkerChoice>& view, BitSize bitPosition)
{
...
template <>
void write(BitStreamWriter& writer, const View<::test_object::polymorphic_allocator::WalkerChoice>& view)
{
    switch (view.zserioChoiceTag())
    {
    case ::test_object::polymorphic_allocator::WalkerChoice::Tag::value8:
...
template <>
View<::test_object::polymorphic_allocator::WalkerChoice> read(BitStreamReader& reader, ::test_object::polymorphic_allocator::WalkerChoice& data,
        ::zserio::UInt8 selector_)
{
    View<::test_object::polymorphic_allocator::WalkerChoice> view(data,
            selector_);
    switch (view.selector())
    {
    case 8:
...
const ::zserio::pmr::ITypeInfo& TypeInfo<::test_object::polymorphic_allocator::WalkerChoice, ::zserio::pmr::PropagatingPolymorphicAllocator<uint8_t>>::get()
{
    ...
    static const ::std::array<::zserio::BasicFieldInfo<AllocatorType>, 4> fields = {
        ...
        ::zserio::BasicFieldInfo<AllocatorType>{
            "value16", // schemaName
            ::zserio::typeInfo<::zserio::UInt16, ::zserio::pmr::PropagatingPolymorphicAllocator<uint8_t>>(), // typeInfo
            {}, // typeArguments
            false, // isExtended
            {}, // alignment
            {}, // offset
        ...
        ::zserio::BasicFieldInfo<AllocatorType>{
            "value64", // schemaName
            ::zserio::typeInfo<::zserio::UInt64, ::zserio::pmr::PropagatingPolymorphicAllocator<uint8_t>>(), // typeInfo
            {}, // typeArguments
            false, // isExtended
            {}, // alignment
            {}, // offset
    ...
    static const ::zserio::detail::ChoiceTypeInfo<AllocatorType> typeInfo = {
        ...
        {
            return ::std::allocate_shared<::zserio::detail::ReflectableDataOwner<::test_object::polymorphic_allocator::WalkerChoice>>(allocator, allocator);
        },
...
template <>
::zserio::pmr::IReflectableDataConstPtr reflectable(const ::test_object::polymorphic_allocator::WalkerChoice& value, const ::zserio::pmr::PropagatingPolymorphicAllocator<uint8_t>& allocator)
{
    ...
    public:
        ...
        explicit Reflectable(const ::test_object::polymorphic_allocator::WalkerChoice& object, const ::zserio::pmr::PropagatingPolymorphicAllocator<uint8_t>& alloc) :
                ::zserio::detail::ReflectableDataConstAllocatorHolderBase<::zserio::pmr::PropagatingPolymorphicAllocator<uint8_t>>(typeInfo<::test_object::polymorphic_allocator::WalkerChoice>(), alloc),
                m_object(object)
        {}
...
template <>
::zserio::pmr::IReflectableDataPtr reflectable(::test_object::polymorphic_allocator::WalkerChoice& value, const ::zserio::pmr::PropagatingPolymorphicAllocator<uint8_t>& allocator)
{
    ...
    public:
        ...
        explicit Reflectable(::test_object::polymorphic_allocator::WalkerChoice& object, const ::zserio::pmr::PropagatingPolymorphicAllocator<uint8_t>& alloc) :
                ::zserio::detail::ReflectableDataAllocatorHolderBase<::zserio::pmr::PropagatingPolymorphicAllocator<uint8_t>>(typeInfo<::test_object::polymorphic_allocator::WalkerChoice>(), alloc),
                m_object(object)
        {}
...
template <>
::zserio::pmr::IIntrospectableViewConstPtr introspectable(const View<::test_object::polymorphic_allocator::WalkerChoice>& view, const ::zserio::pmr::PropagatingPolymorphicAllocator<uint8_t>& allocator)
{
    class Introspectable : public ::zserio::detail::CompoundIntrospectableViewBase<::test_object::polymorphic_allocator::WalkerChoice, ::zserio::pmr::PropagatingPolymorphicAllocator<uint8_t>>
    {
    public:
        Introspectable(const ::zserio::View<::test_object::polymorphic_allocator::WalkerChoice>& view_, const ::zserio::pmr::PropagatingPolymorphicAllocator<uint8_t>& allocator) :
                ::zserio::detail::CompoundIntrospectableViewBase<::test_object::polymorphic_allocator::WalkerChoice, ::zserio::pmr::PropagatingPolymorphicAllocator<uint8_t>>(
                        view_, allocator)
        {}
...
size_t hash<::test_object::polymorphic_allocator::WalkerChoice>::operator()(const ::test_object::polymorphic_allocator::WalkerChoice& value) const
{
    uint32_t result = ::zserio::HASH_SEED;
    result = ::zserio::calcHashCode(result, static_cast<const ::test_object::polymorphic_allocator::WalkerChoice::Base&>(value));
    return static_cast<size_t>(result);
}

size_t hash<::zserio::View<::test_object::polymorphic_allocator::WalkerChoice>>::operator()(const ::zserio::View<::test_object::polymorphic_allocator::WalkerChoice>& view) const
{
    uint32_t result = ::zserio::HASH_SEED;
