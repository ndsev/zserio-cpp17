...
WalkerObject::WalkerObject(
        ...
        ::zserio::pmr::Optional<::test_object::std_polymorphic_allocator::WalkerNested> nested_,
        ::zserio::pmr::String text_,
        ::zserio::pmr::Vector<::test_object::std_polymorphic_allocator::WalkerUnion> unionArray_,
        ::zserio::pmr::Optional<::zserio::pmr::Vector<::test_object::std_polymorphic_allocator::WalkerUnion>> optionalUnionArray_,
...
::zserio::pmr::Optional<View<::test_object::std_polymorphic_allocator::WalkerNested>> View<::test_object::std_polymorphic_allocator::WalkerObject>::nested() const
{
    if (m_data->nested.has_value())
    {
        return ::zserio::pmr::Optional<View<::test_object::std_polymorphic_allocator::WalkerNested>>{
                ::std::in_place, m_data->nested.get_allocator(), *m_data->nested};
    }
    else
    {
        return ::zserio::pmr::Optional<View<::test_object::std_polymorphic_allocator::WalkerNested>>(::std::nullopt, m_data->nested.get_allocator());
    }
}
...
::zserio::pmr::Optional<ArrayView<const ::test_object::std_polymorphic_allocator::WalkerUnion>> View<::test_object::std_polymorphic_allocator::WalkerObject>::optionalUnionArray() const
{
    if (m_data->optionalUnionArray.has_value())
    {
        return ::zserio::pmr::Optional<ArrayView<const ::test_object::std_polymorphic_allocator::WalkerUnion>>{
                ::std::in_place, m_data->optionalUnionArray.get_allocator(), *m_data->optionalUnionArray};
    }
    else
    {
        return ::zserio::pmr::Optional<ArrayView<const ::test_object::std_polymorphic_allocator::WalkerUnion>>(::std::nullopt, m_data->optionalUnionArray.get_allocator());
    }
}
...
const ::zserio::pmr::ITypeInfo& TypeInfo<::test_object::std_polymorphic_allocator::WalkerObject, ::std::pmr::polymorphic_allocator<uint8_t>>::get()
{
        ...
        ::test_object::std_polymorphic_allocator::WalkerObject& value, const ::std::pmr::polymorphic_allocator<uint8_t>& allocator)
{
    ...
    public:
        ...
        void setField(::std::string_view name, const ::zserio::pmr::Any& value) override
        {
            ...
            if (name == "unionArray")
            {
                m_object.unionArray = ::zserio::ReflectableUtil::fromAny<::zserio::pmr::Vector<::test_object::std_polymorphic_allocator::WalkerUnion>>(value);
                return;
            }
            if (name == "optionalUnionArray")
            {
                ...
                m_object.optionalUnionArray = ::zserio::ReflectableUtil::fromAny<::zserio::pmr::Vector<::test_object::std_polymorphic_allocator::WalkerUnion>>(value);
                return;
            }
            if (name == "choiceSelector")
            {
        ...
        ::zserio::pmr::IReflectableDataPtr createField(::std::string_view name) override
        {
            ...
            if (name == "unionArray")
            {
                m_object.unionArray = ::zserio::pmr::Vector<::test_object::std_polymorphic_allocator::WalkerUnion>(get_allocator());
                return ::zserio::reflectableArray(m_object.unionArray, get_allocator());
            }
            if (name == "optionalUnionArray")
            {
                m_object.optionalUnionArray = ::zserio::pmr::Vector<::test_object::std_polymorphic_allocator::WalkerUnion>(get_allocator());
                return ::zserio::reflectableArray(*m_object.optionalUnionArray, get_allocator());
            }
            if (name == "choiceSelector")
            {
...
template <>
::zserio::pmr::IIntrospectableViewConstPtr introspectable(const View<::test_object::std_polymorphic_allocator::WalkerObject>& view, const ::std::pmr::polymorphic_allocator<uint8_t>& allocator)
{
