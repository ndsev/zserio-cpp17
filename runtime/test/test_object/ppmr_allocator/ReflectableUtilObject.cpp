...
{
    return View<::test_object::ppmr_allocator::ReflectableUtilChoice>{
...
template <>
void validate(const View<::test_object::ppmr_allocator::ReflectableUtilObject>& view, ::std::string_view)
{
...
template <>
BitSize bitSizeOf(const View<::test_object::ppmr_allocator::ReflectableUtilObject>& view, BitSize bitPosition)
{
...
template <>
void write(BitStreamWriter& writer, const View<::test_object::ppmr_allocator::ReflectableUtilObject>& view)
{
    auto choiceParam_ = view.choiceParam();
...
template <>
View<::test_object::ppmr_allocator::ReflectableUtilObject> read(BitStreamReader& reader, ::test_object::ppmr_allocator::ReflectableUtilObject& data)
{
