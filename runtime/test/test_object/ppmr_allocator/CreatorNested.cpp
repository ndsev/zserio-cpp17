...
::zserio::pmr::BitBufferView View<::test_object::std_polymorphic_allocator::CreatorNested>::externData() const
{
...
const ::zserio::pmr::ITypeInfo& TypeInfo<::test_object::std_polymorphic_allocator::CreatorNested, ::std::pmr::polymorphic_allocator<uint8_t>>::get()
{
...
template <>
::zserio::pmr::IIntrospectableViewConstPtr introspectable(const View<::test_object::std_polymorphic_allocator::CreatorNested>& view, const ::std::pmr::polymorphic_allocator<uint8_t>& allocator)
{
