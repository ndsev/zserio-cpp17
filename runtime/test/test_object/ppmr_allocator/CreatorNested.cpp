...
{
    return ::zserio::ppmr::BitBufferView{
            m_data->externData};
}
...
template <>
void validate(const View<::test_object::ppmr_allocator::CreatorNested>& view, ::std::string_view)
{
...
template <>
BitSize bitSizeOf(const View<::test_object::ppmr_allocator::CreatorNested>& view, BitSize bitPosition)
{
...
template <>
void write(BitStreamWriter& writer, const View<::test_object::ppmr_allocator::CreatorNested>& view)
{
    auto value_ = view.value();
    write(writer, value_);
    auto text_ = view.text();
...
template <>
View<::test_object::ppmr_allocator::CreatorNested> read(BitStreamReader& reader, ::test_object::ppmr_allocator::CreatorNested& data,
