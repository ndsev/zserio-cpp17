...
template <>
struct TypeInfo<::test_object::ppmr_allocator::ReflectableBitmask, ::zserio::ppmr::PropagatingPolymorphicAllocator<uint8_t>>
{
...
{
    size_t operator()(const ::test_object::ppmr_allocator::ReflectableBitmask& value) const;
};
