...
template <>
struct TypeInfo<::test_object::ppmr_allocator::ReflectableUtilBitmask, ::zserio::ppmr::PropagatingPolymorphicAllocator<uint8_t>>
{
...
{
    size_t operator()(const ::test_object::ppmr_allocator::ReflectableUtilBitmask& value) const;
};
