...
View<::test_object::ppmr_allocator::ReflectableUtilChoice>::ArrayType View<::test_object::ppmr_allocator::ReflectableUtilChoice>::array() const
{
    return ArrayType(get<::test_object::ppmr_allocator::ReflectableUtilChoice::Tag::array>(*m_data));
}
...
::zserio::ppmr::IReflectableDataConstPtr Reflectable<::test_object::ppmr_allocator::ReflectableUtilChoice, ::zserio::ppmr::PropagatingPolymorphicAllocator<uint8_t>>::create(
        const ::test_object::ppmr_allocator::ReflectableUtilChoice& value, const ::zserio::ppmr::PropagatingPolymorphicAllocator<uint8_t>& allocator)
{
    ...
    public:
        ...
        explicit ReflectableImpl(const ::test_object::ppmr_allocator::ReflectableUtilChoice& object, const ::zserio::ppmr::PropagatingPolymorphicAllocator<uint8_t>& alloc = {}) :
...
::zserio::ppmr::IReflectableDataPtr Reflectable<::test_object::ppmr_allocator::ReflectableUtilChoice, ::zserio::ppmr::PropagatingPolymorphicAllocator<uint8_t>>::create(
        ::test_object::ppmr_allocator::ReflectableUtilChoice& value, const ::zserio::ppmr::PropagatingPolymorphicAllocator<uint8_t>& allocator)
{
    ...
    public:
        ...
        explicit ReflectableImpl(::test_object::ppmr_allocator::ReflectableUtilChoice& object, const ::zserio::ppmr::PropagatingPolymorphicAllocator<uint8_t>& alloc = {}) :
...
::zserio::ppmr::IIntrospectableViewConstPtr Introspectable<::test_object::ppmr_allocator::ReflectableUtilChoice, ::zserio::ppmr::PropagatingPolymorphicAllocator<uint8_t>>::create(
        const View<::test_object::ppmr_allocator::ReflectableUtilChoice>& view, const ::zserio::ppmr::PropagatingPolymorphicAllocator<uint8_t>& allocator)
{
    class IntrospectableImpl : public ::zserio::detail::CompoundIntrospectableViewBase<::test_object::ppmr_allocator::ReflectableUtilChoice, ::zserio::ppmr::PropagatingPolymorphicAllocator<uint8_t>>
    {
    public:
        explicit IntrospectableImpl(const ::zserio::View<::test_object::ppmr_allocator::ReflectableUtilChoice>& view_, const ::zserio::ppmr::PropagatingPolymorphicAllocator<uint8_t>& alloc = {}) :
