...
{
    class Introspectable : public ::zserio::detail::IntrospectableViewBase<::test_object::ppmr_allocator::CreatorBitmask, ::zserio::ppmr::PropagatingPolymorphicAllocator<uint8_t>>
    {
    public:
        explicit Introspectable(::test_object::ppmr_allocator::CreatorBitmask bitmask) :
                ::zserio::detail::IntrospectableViewBase<::test_object::ppmr_allocator::CreatorBitmask, ::zserio::ppmr::PropagatingPolymorphicAllocator<uint8_t>>(
