...
template <>
void validate(const View<::test_object::ppmr_allocator::WalkerChoice>& view, ::std::string_view)
{
        ...
        ::zserio::UInt8 selector_)
{
    ...
    case 8:
        ...
        read(reader, data.get<::test_object::ppmr_allocator::WalkerChoice::Tag::value8>());
        break;
    case 16:
        data.emplace<::test_object::ppmr_allocator::WalkerChoice::Tag::value16>();
        read(reader, data.get<::test_object::ppmr_allocator::WalkerChoice::Tag::value16>());
        break;
    case 32:
        data.emplace<::test_object::ppmr_allocator::WalkerChoice::Tag::value32>();
        read(reader, data.get<::test_object::ppmr_allocator::WalkerChoice::Tag::value32>());
        break;
    case 64:
        data.emplace<::test_object::ppmr_allocator::WalkerChoice::Tag::value64>();
        read(reader, data.get<::test_object::ppmr_allocator::WalkerChoice::Tag::value64>());
        break;
    default:
        // empty
        break;
...
::zserio::ppmr::IReflectableDataConstPtr reflectable(const ::test_object::ppmr_allocator::WalkerChoice& value, const ::zserio::ppmr::PropagatingPolymorphicAllocator<uint8_t>& allocator)
{
    ...
    public:
        ...
        explicit Reflectable(const ::test_object::ppmr_allocator::WalkerChoice& object, const ::zserio::ppmr::PropagatingPolymorphicAllocator<uint8_t>& alloc = {}) :
...
::zserio::ppmr::IReflectableDataPtr reflectable(::test_object::ppmr_allocator::WalkerChoice& value, const ::zserio::ppmr::PropagatingPolymorphicAllocator<uint8_t>& allocator)
{
    ...
    public:
        ...
        explicit Reflectable(::test_object::ppmr_allocator::WalkerChoice& object, const ::zserio::ppmr::PropagatingPolymorphicAllocator<uint8_t>& alloc = {}) :
        ...
        void setField(::std::string_view name, const ::zserio::ppmr::Any& value) override
        {
            if (name == "value8")
            {
                m_object.emplace<::test_object::ppmr_allocator::WalkerChoice::Tag::value8>(
                        ::zserio::ReflectableUtil::fromAny<::zserio::UInt8>(value));
                return;
            }
            if (name == "value16")
            {
                m_object.emplace<::test_object::ppmr_allocator::WalkerChoice::Tag::value16>(
                        ::zserio::ReflectableUtil::fromAny<::zserio::UInt16>(value));
                return;
            }
            if (name == "value32")
            {
                m_object.emplace<::test_object::ppmr_allocator::WalkerChoice::Tag::value32>(
                        ::zserio::ReflectableUtil::fromAny<::zserio::UInt32>(value));
                return;
            }
            if (name == "value64")
            {
                m_object.emplace<::test_object::ppmr_allocator::WalkerChoice::Tag::value64>(
...
{
    class Introspectable : public ::zserio::detail::CompoundIntrospectableViewBase<::test_object::ppmr_allocator::WalkerChoice, ::zserio::ppmr::PropagatingPolymorphicAllocator<uint8_t>>
    {
    public:
        explicit Introspectable(const ::zserio::View<::test_object::ppmr_allocator::WalkerChoice>& view_, const ::zserio::ppmr::PropagatingPolymorphicAllocator<uint8_t>& alloc = {}) :
