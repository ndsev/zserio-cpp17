...
{
    return View<::test_object::ppmr_allocator::CreatorNested>(element, ::zserio::UInt32(static_cast<::zserio::UInt32::ValueType>(owner.value())));
}
...
{
    return View<::test_object::ppmr_allocator::CreatorNested>{
...
{
    return ArrayView<const ::test_object::ppmr_allocator::CreatorNested, ZserioNestedArrayArrayTraits>{
            m_data->nestedArray, *this};
}

ArrayView<const ::zserio::ppmr::String> View<::test_object::ppmr_allocator::CreatorObject>::textArray() const
{
    return ArrayView<const ::zserio::ppmr::String>{
            m_data->textArray};
}
...
::zserio::ppmr::Optional<ArrayView<const ::zserio::ppmr::BitBuffer>> View<::test_object::ppmr_allocator::CreatorObject>::externArray() const
{
    ...
    {
        return ::zserio::ppmr::Optional<ArrayView<const ::zserio::ppmr::BitBuffer>>{
...
::zserio::ppmr::Optional<ArrayView<const ::zserio::ppmr::Bytes>> View<::test_object::ppmr_allocator::CreatorObject>::bytesArray() const
{
    ...
    {
        return ::zserio::ppmr::Optional<ArrayView<const ::zserio::ppmr::Bytes>>{
...
::zserio::ppmr::Optional<View<::test_object::ppmr_allocator::CreatorNested>> View<::test_object::ppmr_allocator::CreatorObject>::optionalNested() const
{
    ...
    {
        return ::zserio::ppmr::Optional<View<::test_object::ppmr_allocator::CreatorNested>>{
...
template <>
void validate(const View<::test_object::ppmr_allocator::CreatorObject>& view, ::std::string_view)
{
...
View<::test_object::ppmr_allocator::CreatorObject> read(BitStreamReader& reader, ::test_object::ppmr_allocator::CreatorObject& data)
{
    ...
    (void)readWithTraits<ArrayType::AUTO, View<::test_object::ppmr_allocator::CreatorObject>::ZserioNestedArrayArrayTraits>(reader, data.nestedArray, view);
        ...
        const ::test_object::ppmr_allocator::CreatorObject& value, const ::zserio::ppmr::PropagatingPolymorphicAllocator<uint8_t>& allocator)
{
    ...
    public:
        ...
        explicit Reflectable(const ::test_object::ppmr_allocator::CreatorObject& object, const ::zserio::ppmr::PropagatingPolymorphicAllocator<uint8_t>& alloc = {}) :
        ...
        ::test_object::ppmr_allocator::CreatorObject& value, const ::zserio::ppmr::PropagatingPolymorphicAllocator<uint8_t>& allocator)
{
    ...
    public:
        ...
        explicit Reflectable(::test_object::ppmr_allocator::CreatorObject& object, const ::zserio::ppmr::PropagatingPolymorphicAllocator<uint8_t>& alloc = {}) :
...
{
    class Introspectable : public ::zserio::detail::CompoundIntrospectableViewBase<::test_object::ppmr_allocator::CreatorObject, ::zserio::ppmr::PropagatingPolymorphicAllocator<uint8_t>>
    {
    public:
        explicit Introspectable(const ::zserio::View<::test_object::ppmr_allocator::CreatorObject>& view_, const ::zserio::ppmr::PropagatingPolymorphicAllocator<uint8_t>& alloc = {}) :
