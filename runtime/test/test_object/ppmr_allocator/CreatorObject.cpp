...
CreatorObject::CreatorObject(
        ...
        ::zserio::pmr::Vector<::test_object::std_polymorphic_allocator::CreatorNested> nestedArray_,
        ...
        ::zserio::pmr::Optional<::test_object::std_polymorphic_allocator::CreatorNested> optionalNested_,
...
ArrayView<const ::zserio::pmr::String> View<::test_object::std_polymorphic_allocator::CreatorObject>::textArray() const
{
    return ArrayView<const ::zserio::pmr::String>{
            m_data->textArray};
}

::zserio::pmr::Optional<ArrayView<const ::zserio::pmr::BitBuffer>> View<::test_object::std_polymorphic_allocator::CreatorObject>::externArray() const
{
...
::zserio::pmr::Optional<ArrayView<const ::zserio::pmr::Bytes>> View<::test_object::std_polymorphic_allocator::CreatorObject>::bytesArray() const
{
...
::zserio::pmr::Optional<::zserio::Bool> View<::test_object::std_polymorphic_allocator::CreatorObject>::optionalBool() const
{
    return m_data->optionalBool;
}

::zserio::pmr::Optional<View<::test_object::std_polymorphic_allocator::CreatorNested>> View<::test_object::std_polymorphic_allocator::CreatorObject>::optionalNested() const
{
    if (m_data->optionalNested.has_value())
    {
        return ::zserio::pmr::Optional<View<::test_object::std_polymorphic_allocator::CreatorNested>>{
    ...
    {
        return ::zserio::pmr::Optional<View<::test_object::std_polymorphic_allocator::CreatorNested>>(::std::nullopt, m_data->optionalNested.get_allocator());
    }
}
...
const ::zserio::pmr::ITypeInfo& TypeInfo<::test_object::std_polymorphic_allocator::CreatorObject, ::std::pmr::polymorphic_allocator<uint8_t>>::get()
{
        ...
        ::test_object::std_polymorphic_allocator::CreatorObject& value, const ::std::pmr::polymorphic_allocator<uint8_t>& allocator)
{
    ...
    public:
        ...
        void setField(::std::string_view name, const ::zserio::pmr::Any& value) override
        {
            ...
            if (name == "nestedArray")
            {
                m_object.nestedArray = ::zserio::ReflectableUtil::fromAny<::zserio::pmr::Vector<::test_object::std_polymorphic_allocator::CreatorNested>>(value);
                return;
            }
            if (name == "textArray")
            {
        ...
        ::zserio::pmr::IReflectableDataPtr createField(::std::string_view name) override
        {
            ...
            if (name == "nestedArray")
            {
                m_object.nestedArray = ::zserio::pmr::Vector<::test_object::std_polymorphic_allocator::CreatorNested>(get_allocator());
                return ::zserio::reflectableArray(m_object.nestedArray, get_allocator());
            }
            if (name == "textArray")
            {
...
template <>
::zserio::pmr::IIntrospectableViewConstPtr introspectable(const View<::test_object::std_polymorphic_allocator::CreatorObject>& view, const ::std::pmr::polymorphic_allocator<uint8_t>& allocator)
{
