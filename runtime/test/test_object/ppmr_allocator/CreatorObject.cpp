...
View<::test_object::ppmr_allocator::CreatorObject>::NestedArrayType View<::test_object::ppmr_allocator::CreatorObject>::nestedArray() const
{
    return NestedArrayType(m_data->nestedArray, *this);
}

View<::test_object::ppmr_allocator::CreatorObject>::TextArrayType View<::test_object::ppmr_allocator::CreatorObject>::textArray() const
{
    return TextArrayType(m_data->textArray);
}

::zserio::ppmr::Optional<View<::test_object::ppmr_allocator::CreatorObject>::ExternArrayType> View<::test_object::ppmr_allocator::CreatorObject>::externArray() const
{
    if (m_data->externArray.has_value())
    {
        return ::zserio::ppmr::Optional<ExternArrayType>(::std::in_place, m_data->externArray.get_allocator(), *m_data->externArray);
    }
    else
    {
        return ::zserio::ppmr::Optional<ExternArrayType>(::std::nullopt, m_data->externArray.get_allocator());
    }
}

::zserio::ppmr::Optional<View<::test_object::ppmr_allocator::CreatorObject>::BytesArrayType> View<::test_object::ppmr_allocator::CreatorObject>::bytesArray() const
{
    if (m_data->bytesArray.has_value())
    {
        return ::zserio::ppmr::Optional<BytesArrayType>(::std::in_place, m_data->bytesArray.get_allocator(), *m_data->bytesArray);
    }
    else
    {
        return ::zserio::ppmr::Optional<BytesArrayType>(::std::nullopt, m_data->bytesArray.get_allocator());
    }
}
