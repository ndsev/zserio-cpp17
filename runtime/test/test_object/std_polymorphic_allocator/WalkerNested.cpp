...
View<::test_object::std_polymorphic_allocator::WalkerNested>::View(const ::test_object::std_polymorphic_allocator::WalkerNested& data) noexcept :
        m_data(&data)
{}

View<::test_object::std_polymorphic_allocator::WalkerNested>::View(const ::test_object::std_polymorphic_allocator::WalkerNested& data,
        const View&) noexcept :
        m_data(&data)
{}

::std::string_view View<::test_object::std_polymorphic_allocator::WalkerNested>::text() const
{
    return ::std::string_view{
            m_data->text};
}

const ::test_object::std_polymorphic_allocator::WalkerNested& View<::test_object::std_polymorphic_allocator::WalkerNested>::zserioData() const
{
    return *m_data;
}
...
template <>
void validate(const View<::test_object::std_polymorphic_allocator::WalkerNested>& view, ::std::string_view)
{
...
{
    View<::test_object::std_polymorphic_allocator::WalkerNested> view(data);
    read(reader, data.text);
    return view;
}

const ::zserio::std_pmr::ITypeInfo& TypeInfo<::test_object::std_polymorphic_allocator::WalkerNested, ::std::pmr::polymorphic_allocator<uint8_t>>::get()
{
    ...
    static const ::zserio::detail::StructTypeInfo<AllocatorType> typeInfo = {
        "test_object.std_polymorphic_allocator.WalkerNested",
        [](const AllocatorType& allocator) -> ::zserio::std_pmr::IReflectableDataPtr
        {
            return ::std::allocate_shared<::zserio::ReflectableDataOwner<::test_object::std_polymorphic_allocator::WalkerNested>>(allocator);
        },
...
::zserio::std_pmr::IReflectableDataConstPtr reflectable(
        const ::test_object::std_polymorphic_allocator::WalkerNested& value, const ::std::pmr::polymorphic_allocator<uint8_t>& allocator)
{
    ...
    public:
        ...
        explicit Reflectable(const ::test_object::std_polymorphic_allocator::WalkerNested& object, const ::std::pmr::polymorphic_allocator<uint8_t>& alloc = {}) :
                ::zserio::ReflectableDataConstAllocatorHolderBase<::std::pmr::polymorphic_allocator<uint8_t>>(typeInfo<::test_object::std_polymorphic_allocator::WalkerNested>(), alloc),
                m_object(object)
        {}
    ...
    private:
        const ::test_object::std_polymorphic_allocator::WalkerNested& m_object;
    };
...
::zserio::std_pmr::IReflectableDataPtr reflectable(
        ::test_object::std_polymorphic_allocator::WalkerNested& value, const ::std::pmr::polymorphic_allocator<uint8_t>& allocator)
{
    ...
    public:
        ...
        explicit Reflectable(::test_object::std_polymorphic_allocator::WalkerNested& object, const ::std::pmr::polymorphic_allocator<uint8_t>& alloc = {}) :
                ::zserio::ReflectableDataAllocatorHolderBase<::std::pmr::polymorphic_allocator<uint8_t>>(typeInfo<::test_object::std_polymorphic_allocator::WalkerNested>(), alloc),
                m_object(object)
        {}
    ...
    private:
        ::test_object::std_polymorphic_allocator::WalkerNested& m_object;
    };
...
{
    class Introspectable : public ::zserio::CompoundIntrospectableViewBase<::test_object::std_polymorphic_allocator::WalkerNested, ::std::pmr::polymorphic_allocator<uint8_t>>
    {
    public:
        explicit Introspectable(const ::zserio::View<::test_object::std_polymorphic_allocator::WalkerNested>& view_, const ::std::pmr::polymorphic_allocator<uint8_t>& alloc = {}) :
                ::zserio::CompoundIntrospectableViewBase<::test_object::std_polymorphic_allocator::WalkerNested, ::std::pmr::polymorphic_allocator<uint8_t>>(
                        view_, alloc)
        {}
...
size_t hash<::test_object::std_polymorphic_allocator::WalkerNested>::operator()(const ::test_object::std_polymorphic_allocator::WalkerNested& data) const
{
...
size_t hash<::zserio::View<::test_object::std_polymorphic_allocator::WalkerNested>>::operator()(const ::zserio::View<::test_object::std_polymorphic_allocator::WalkerNested>& view) const
{
    uint32_t result = ::zserio::HASH_SEED;
