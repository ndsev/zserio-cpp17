...
#ifndef TEST_OBJECT_STD_POLYMORPHIC_ALLOCATOR_REFLECTABLE_NESTED_H
#define TEST_OBJECT_STD_POLYMORPHIC_ALLOCATOR_REFLECTABLE_NESTED_H
...
template <>
class View<::test_object::std_polymorphic_allocator::ReflectableNested>
{
public:
    explicit View(const ::test_object::std_polymorphic_allocator::ReflectableNested& data,
    ...
    const ::test_object::std_polymorphic_allocator::ReflectableNested& zserioData() const;

protected:
    View(const ::test_object::std_polymorphic_allocator::ReflectableNested& data, const View& other) noexcept;

private:
    const ::test_object::std_polymorphic_allocator::ReflectableNested* m_data;
...
template <>
void validate(const View<::test_object::std_polymorphic_allocator::ReflectableNested>& view, ::std::string_view fieldName);
...
template <>
struct TypeInfo<::test_object::std_polymorphic_allocator::ReflectableNested, ::std::pmr::polymorphic_allocator<uint8_t>>
{
...
template <>
::zserio::pmr::IReflectableDataConstPtr reflectable(const ::test_object::std_polymorphic_allocator::ReflectableNested& value, const ::std::pmr::polymorphic_allocator<uint8_t>& allocator);

template <>
::zserio::pmr::IReflectableDataPtr reflectable(::test_object::std_polymorphic_allocator::ReflectableNested& value, const ::std::pmr::polymorphic_allocator<uint8_t>& allocator);

template <>
::zserio::pmr::IIntrospectableViewConstPtr introspectable(const View<::test_object::std_polymorphic_allocator::ReflectableNested>& view, const ::std::pmr::polymorphic_allocator<uint8_t>& allocator);
...
template <>
struct hash<::test_object::std_polymorphic_allocator::ReflectableNested>
{
    size_t operator()(const ::test_object::std_polymorphic_allocator::ReflectableNested& data) const;
};

template <>
struct hash<::zserio::View<::test_object::std_polymorphic_allocator::ReflectableNested>>
{
    size_t operator()(const ::zserio::View<::test_object::std_polymorphic_allocator::ReflectableNested>& view) const;
};

} // namespace std

#endif // TEST_OBJECT_STD_POLYMORPHIC_ALLOCATOR_REFLECTABLE_NESTED_H
