...
#include <test_object/std_polymorphic_allocator/CreatorNested.h>
...
View<::test_object::std_polymorphic_allocator::CreatorNested>::View(const ::test_object::std_polymorphic_allocator::CreatorNested& data,
...
::zserio::UInt32 View<::test_object::std_polymorphic_allocator::CreatorNested>::param() const
{
    return m_param_;
}

::zserio::UInt32 View<::test_object::std_polymorphic_allocator::CreatorNested>::value() const
{
    return m_data->value;
}

::std::string_view View<::test_object::std_polymorphic_allocator::CreatorNested>::text() const
{
    return ::std::string_view{
            m_data->text};
}

::zserio::std_pmr::BitBufferView View<::test_object::std_polymorphic_allocator::CreatorNested>::externData() const
{
    return ::zserio::std_pmr::BitBufferView{
            m_data->externData};
}

BytesView View<::test_object::std_polymorphic_allocator::CreatorNested>::bytesData() const
{
    return BytesView{
            m_data->bytesData};
}

::test_object::std_polymorphic_allocator::CreatorEnum View<::test_object::std_polymorphic_allocator::CreatorNested>::creatorEnum() const
{
    return m_data->creatorEnum;
}

::test_object::std_polymorphic_allocator::CreatorBitmask View<::test_object::std_polymorphic_allocator::CreatorNested>::creatorBitmask() const
{
    return m_data->creatorBitmask;
}

const ::test_object::std_polymorphic_allocator::CreatorNested& View<::test_object::std_polymorphic_allocator::CreatorNested>::zserioData() const
{
    return *m_data;
}
...
template <>
void validate(const View<::test_object::std_polymorphic_allocator::CreatorNested>& view, ::std::string_view)
{
...
{
    View<::test_object::std_polymorphic_allocator::CreatorNested> view(data,
            param_);
...
const ::zserio::std_pmr::ITypeInfo& TypeInfo<::test_object::std_polymorphic_allocator::CreatorNested, ::std::pmr::polymorphic_allocator<uint8_t>>::get()
{
    ...
    static const ::std::array<::zserio::BasicFieldInfo<AllocatorType>, 6> fields = {
        ...
        ::zserio::BasicFieldInfo<AllocatorType>{
            ...
            ::zserio::typeInfo<::test_object::std_polymorphic_allocator::CreatorEnum, ::std::pmr::polymorphic_allocator<uint8_t>>(), // typeInfo
            {}, // typeArguments
            false, // isExtended
            {}, // alignment
            {}, // offset
        ...
        ::zserio::BasicFieldInfo<AllocatorType>{
            ...
            ::zserio::typeInfo<::test_object::std_polymorphic_allocator::CreatorBitmask, ::std::pmr::polymorphic_allocator<uint8_t>>(), // typeInfo
            {}, // typeArguments
            false, // isExtended
            {}, // alignment
            {}, // offset
    ...
    static const ::zserio::detail::StructTypeInfo<AllocatorType> typeInfo = {
        "test_object.std_polymorphic_allocator.CreatorNested",
        [](const AllocatorType& allocator) -> ::zserio::std_pmr::IReflectableDataPtr
        {
            return ::std::allocate_shared<::zserio::ReflectableDataOwner<::test_object::std_polymorphic_allocator::CreatorNested>>(allocator);
        },
...
::zserio::std_pmr::IReflectableDataConstPtr reflectable(
        const ::test_object::std_polymorphic_allocator::CreatorNested& value, const ::std::pmr::polymorphic_allocator<uint8_t>& allocator)
{
    ...
    public:
        ...
        explicit Reflectable(const ::test_object::std_polymorphic_allocator::CreatorNested& object, const ::std::pmr::polymorphic_allocator<uint8_t>& alloc = {}) :
                ::zserio::ReflectableDataConstAllocatorHolderBase<::std::pmr::polymorphic_allocator<uint8_t>>(typeInfo<::test_object::std_polymorphic_allocator::CreatorNested>(), alloc),
                m_object(object)
        {}
    ...
    private:
        const ::test_object::std_polymorphic_allocator::CreatorNested& m_object;
    };
...
::zserio::std_pmr::IReflectableDataPtr reflectable(
        ::test_object::std_polymorphic_allocator::CreatorNested& value, const ::std::pmr::polymorphic_allocator<uint8_t>& allocator)
{
    ...
    public:
        ...
        explicit Reflectable(::test_object::std_polymorphic_allocator::CreatorNested& object, const ::std::pmr::polymorphic_allocator<uint8_t>& alloc = {}) :
                ::zserio::ReflectableDataAllocatorHolderBase<::std::pmr::polymorphic_allocator<uint8_t>>(typeInfo<::test_object::std_polymorphic_allocator::CreatorNested>(), alloc),
                m_object(object)
        {}
        ...
        void setField(::std::string_view name, const ::zserio::std_pmr::Any& value) override
        {
            ...
            if (name == "externData")
            {
                m_object.externData = ::zserio::ReflectableUtil::fromAny<::zserio::std_pmr::BitBuffer>(value);
                return;
            }
            if (name == "bytesData")
            {
                m_object.bytesData = ::zserio::ReflectableUtil::fromAny<::zserio::std_pmr::Bytes>(value);
                return;
            }
            if (name == "creatorEnum")
            {
                m_object.creatorEnum = ::zserio::ReflectableUtil::fromAny<::test_object::std_polymorphic_allocator::CreatorEnum>(value);
                return;
            }
            if (name == "creatorBitmask")
            {
                m_object.creatorBitmask = ::zserio::ReflectableUtil::fromAny<::test_object::std_polymorphic_allocator::CreatorBitmask>(value);
                return;
            }
            throw ::zserio::CppRuntimeException("Field '") << name << "' doesn't exist in 'CreatorNested'!";
        }
        ...
        ::zserio::std_pmr::IReflectableDataPtr createField(::std::string_view name) override
        {
            ...
            if (name == "externData")
            {
                m_object.externData = ::zserio::std_pmr::BitBuffer(get_allocator());
                return ::zserio::reflectable(m_object.externData, get_allocator());
            }
            if (name == "bytesData")
            {
                m_object.bytesData = ::zserio::std_pmr::Bytes(get_allocator());
                return ::zserio::reflectable(m_object.bytesData, get_allocator());
            }
            if (name == "creatorEnum")
            {
                m_object.creatorEnum = ::test_object::std_polymorphic_allocator::CreatorEnum();
                return ::zserio::reflectable(m_object.creatorEnum, get_allocator());
            }
            if (name == "creatorBitmask")
            {
                m_object.creatorBitmask = ::test_object::std_polymorphic_allocator::CreatorBitmask();
                return ::zserio::reflectable(m_object.creatorBitmask, get_allocator());
            }
            throw ::zserio::CppRuntimeException("Field '") << name << "' doesn't exist in 'CreatorNested'!";
        }
    ...
    private:
        ::test_object::std_polymorphic_allocator::CreatorNested& m_object;
    };
...
{
    class Introspectable : public ::zserio::CompoundIntrospectableViewBase<::test_object::std_polymorphic_allocator::CreatorNested, ::std::pmr::polymorphic_allocator<uint8_t>>
    {
    public:
        explicit Introspectable(const ::zserio::View<::test_object::std_polymorphic_allocator::CreatorNested>& view_, const ::std::pmr::polymorphic_allocator<uint8_t>& alloc = {}) :
                ::zserio::CompoundIntrospectableViewBase<::test_object::std_polymorphic_allocator::CreatorNested, ::std::pmr::polymorphic_allocator<uint8_t>>(
                        view_, alloc)
        {}
...
size_t hash<::test_object::std_polymorphic_allocator::CreatorNested>::operator()(const ::test_object::std_polymorphic_allocator::CreatorNested& data) const
{
...
size_t hash<::zserio::View<::test_object::std_polymorphic_allocator::CreatorNested>>::operator()(const ::zserio::View<::test_object::std_polymorphic_allocator::CreatorNested>& view) const
{
    uint32_t result = ::zserio::HASH_SEED;
