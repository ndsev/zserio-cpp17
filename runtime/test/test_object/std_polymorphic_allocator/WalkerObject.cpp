...
#include <test_object/std_polymorphic_allocator/WalkerObject.h>
...
WalkerObject::WalkerObject(
        ...
        ::zserio::std_pmr::Optional<::test_object::std_polymorphic_allocator::WalkerNested> nested_,
        ::zserio::std_pmr::String text_,
        ::zserio::std_pmr::Vector<::test_object::std_polymorphic_allocator::WalkerUnion> unionArray_,
        ::zserio::std_pmr::Optional<::zserio::std_pmr::Vector<::test_object::std_polymorphic_allocator::WalkerUnion>> optionalUnionArray_,
        ::zserio::UInt8 choiceSelector_,
        ::test_object::std_polymorphic_allocator::WalkerChoice choiceField_,
...
bool operator==(const ::test_object::std_polymorphic_allocator::WalkerObject& lhs, const ::test_object::std_polymorphic_allocator::WalkerObject& rhs)
{
    return ::std::tie(
            lhs.identifier,
            lhs.nested,
...
View<::test_object::std_polymorphic_allocator::WalkerObject>::View(const ::test_object::std_polymorphic_allocator::WalkerObject& data) noexcept :
        m_data(&data)
{}

View<::test_object::std_polymorphic_allocator::WalkerObject>::View(const ::test_object::std_polymorphic_allocator::WalkerObject& data,
        const View&) noexcept :
        m_data(&data)
{}

::zserio::UInt32 View<::test_object::std_polymorphic_allocator::WalkerObject>::identifier() const
{
    return m_data->identifier;
}

::zserio::std_pmr::Optional<View<::test_object::std_polymorphic_allocator::WalkerNested>> View<::test_object::std_polymorphic_allocator::WalkerObject>::nested() const
{
    if (m_data->nested.has_value())
    {
        return ::zserio::std_pmr::Optional<View<::test_object::std_polymorphic_allocator::WalkerNested>>{
                ::std::in_place, m_data->nested.get_allocator(), *m_data->nested};
    }
    else
    {
        return ::zserio::std_pmr::Optional<View<::test_object::std_polymorphic_allocator::WalkerNested>>(::std::nullopt, m_data->nested.get_allocator());
    }
}

::std::string_view View<::test_object::std_polymorphic_allocator::WalkerObject>::text() const
{
    return ::std::string_view{
            m_data->text};
}

ArrayView<const ::test_object::std_polymorphic_allocator::WalkerUnion> View<::test_object::std_polymorphic_allocator::WalkerObject>::unionArray() const
{
    return ArrayView<const ::test_object::std_polymorphic_allocator::WalkerUnion>{
            m_data->unionArray};
}

::zserio::std_pmr::Optional<ArrayView<const ::test_object::std_polymorphic_allocator::WalkerUnion>> View<::test_object::std_polymorphic_allocator::WalkerObject>::optionalUnionArray() const
{
    if (m_data->optionalUnionArray.has_value())
    {
        return ::zserio::std_pmr::Optional<ArrayView<const ::test_object::std_polymorphic_allocator::WalkerUnion>>{
                ::std::in_place, m_data->optionalUnionArray.get_allocator(), *m_data->optionalUnionArray};
    }
    else
    {
        return ::zserio::std_pmr::Optional<ArrayView<const ::test_object::std_polymorphic_allocator::WalkerUnion>>(::std::nullopt, m_data->optionalUnionArray.get_allocator());
    }
}

::zserio::UInt8 View<::test_object::std_polymorphic_allocator::WalkerObject>::choiceSelector() const
{
    return m_data->choiceSelector;
}

View<::test_object::std_polymorphic_allocator::WalkerChoice> View<::test_object::std_polymorphic_allocator::WalkerObject>::choiceField() const
{
    return View<::test_object::std_polymorphic_allocator::WalkerChoice>{
            m_data->choiceField, ::zserio::UInt8(static_cast<::zserio::UInt8::ValueType>(choiceSelector()))};
}

const ::test_object::std_polymorphic_allocator::WalkerObject& View<::test_object::std_polymorphic_allocator::WalkerObject>::zserioData() const
{
    return *m_data;
}

bool operator==(const View<::test_object::std_polymorphic_allocator::WalkerObject>& lhs, const View<::test_object::std_polymorphic_allocator::WalkerObject>& rhs)
{
...
template <>
void validate(const View<::test_object::std_polymorphic_allocator::WalkerObject>& view, ::std::string_view)
{
...
template <>
BitSize bitSizeOf(const View<::test_object::std_polymorphic_allocator::WalkerObject>& view, BitSize bitPosition)
{
...
template <>
void write(BitStreamWriter& writer, const View<::test_object::std_polymorphic_allocator::WalkerObject>& view)
{
    auto identifier_ = view.identifier();
...
template <>
View<::test_object::std_polymorphic_allocator::WalkerObject> read(BitStreamReader& reader, ::test_object::std_polymorphic_allocator::WalkerObject& data)
{
    View<::test_object::std_polymorphic_allocator::WalkerObject> view(data);
...
const ::zserio::std_pmr::ITypeInfo& TypeInfo<::test_object::std_polymorphic_allocator::WalkerObject, ::std::pmr::polymorphic_allocator<uint8_t>>::get()
{
    ...
    static const ::std::array<::zserio::BasicFieldInfo<AllocatorType>, 7> fields = {
        ...
        ::zserio::BasicFieldInfo<AllocatorType>{
            ...
            ::zserio::typeInfo<::test_object::std_polymorphic_allocator::WalkerUnion, ::std::pmr::polymorphic_allocator<uint8_t>>(), // typeInfo
            {}, // typeArguments
            false, // isExtended
            {}, // alignment
            {}, // offset
        ...
        ::zserio::BasicFieldInfo<AllocatorType>{
            ...
            ::zserio::typeInfo<::test_object::std_polymorphic_allocator::WalkerChoice, ::std::pmr::polymorphic_allocator<uint8_t>>(), // typeInfo
    ...
    static const ::zserio::detail::StructTypeInfo<AllocatorType> typeInfo = {
        "test_object.std_polymorphic_allocator.WalkerObject",
        [](const AllocatorType& allocator) -> ::zserio::std_pmr::IReflectableDataPtr
        {
            return ::std::allocate_shared<::zserio::ReflectableDataOwner<::test_object::std_polymorphic_allocator::WalkerObject>>(allocator);
        },
...
::zserio::std_pmr::IReflectableDataConstPtr reflectable(
        const ::test_object::std_polymorphic_allocator::WalkerObject& value, const ::std::pmr::polymorphic_allocator<uint8_t>& allocator)
{
    ...
    public:
        ...
        explicit Reflectable(const ::test_object::std_polymorphic_allocator::WalkerObject& object, const ::std::pmr::polymorphic_allocator<uint8_t>& alloc = {}) :
                ::zserio::ReflectableDataConstAllocatorHolderBase<::std::pmr::polymorphic_allocator<uint8_t>>(typeInfo<::test_object::std_polymorphic_allocator::WalkerObject>(), alloc),
                m_object(object)
        {}
    ...
    private:
        const ::test_object::std_polymorphic_allocator::WalkerObject& m_object;
    };
...
::zserio::std_pmr::IReflectableDataPtr reflectable(
        ::test_object::std_polymorphic_allocator::WalkerObject& value, const ::std::pmr::polymorphic_allocator<uint8_t>& allocator)
{
    ...
    public:
        ...
        explicit Reflectable(::test_object::std_polymorphic_allocator::WalkerObject& object, const ::std::pmr::polymorphic_allocator<uint8_t>& alloc = {}) :
                ::zserio::ReflectableDataAllocatorHolderBase<::std::pmr::polymorphic_allocator<uint8_t>>(typeInfo<::test_object::std_polymorphic_allocator::WalkerObject>(), alloc),
                m_object(object)
        {}
        ...
        void setField(::std::string_view name, const ::zserio::std_pmr::Any& value) override
        {
            ...
            if (name == "nested")
            {
                ...
                m_object.nested = ::zserio::ReflectableUtil::fromAny<::test_object::std_polymorphic_allocator::WalkerNested>(value);
                return;
            }
            if (name == "text")
            {
            ...
            if (name == "unionArray")
            {
                m_object.unionArray = ::zserio::ReflectableUtil::fromAny<::zserio::std_pmr::Vector<::test_object::std_polymorphic_allocator::WalkerUnion>>(value);
                return;
            }
            if (name == "optionalUnionArray")
            {
                ...
                m_object.optionalUnionArray = ::zserio::ReflectableUtil::fromAny<::zserio::std_pmr::Vector<::test_object::std_polymorphic_allocator::WalkerUnion>>(value);
                return;
            }
            if (name == "choiceSelector")
            {
            ...
            if (name == "choiceField")
            {
                m_object.choiceField = ::zserio::ReflectableUtil::fromAny<::test_object::std_polymorphic_allocator::WalkerChoice>(value);
                return;
            }
            throw ::zserio::CppRuntimeException("Field '") << name << "' doesn't exist in 'WalkerObject'!";
        }
        ...
        ::zserio::std_pmr::IReflectableDataPtr createField(::std::string_view name) override
        {
            ...
            if (name == "nested")
            {
                m_object.nested = ::test_object::std_polymorphic_allocator::WalkerNested(get_allocator());
                return ::zserio::reflectable(*m_object.nested, get_allocator());
            }
            if (name == "text")
            {
            ...
            if (name == "unionArray")
            {
                m_object.unionArray = ::zserio::std_pmr::Vector<::test_object::std_polymorphic_allocator::WalkerUnion>(get_allocator());
                return ::zserio::reflectableArray(m_object.unionArray, get_allocator());
            }
            if (name == "optionalUnionArray")
            {
                m_object.optionalUnionArray = ::zserio::std_pmr::Vector<::test_object::std_polymorphic_allocator::WalkerUnion>(get_allocator());
                return ::zserio::reflectableArray(*m_object.optionalUnionArray, get_allocator());
            }
            if (name == "choiceSelector")
            {
            ...
            if (name == "choiceField")
            {
                m_object.choiceField = ::test_object::std_polymorphic_allocator::WalkerChoice(get_allocator());
                return ::zserio::reflectable(m_object.choiceField, get_allocator());
            }
            throw ::zserio::CppRuntimeException("Field '") << name << "' doesn't exist in 'WalkerObject'!";
        }
    ...
    private:
        ::test_object::std_polymorphic_allocator::WalkerObject& m_object;
    };
...
template <>
::zserio::std_pmr::IIntrospectableViewConstPtr introspectable(const View<::test_object::std_polymorphic_allocator::WalkerObject>& view, const ::std::pmr::polymorphic_allocator<uint8_t>& allocator)
{
    class Introspectable : public ::zserio::CompoundIntrospectableViewBase<::test_object::std_polymorphic_allocator::WalkerObject, ::std::pmr::polymorphic_allocator<uint8_t>>
    {
    public:
        explicit Introspectable(const ::zserio::View<::test_object::std_polymorphic_allocator::WalkerObject>& view_, const ::std::pmr::polymorphic_allocator<uint8_t>& alloc = {}) :
                ::zserio::CompoundIntrospectableViewBase<::test_object::std_polymorphic_allocator::WalkerObject, ::std::pmr::polymorphic_allocator<uint8_t>>(
                        view_, alloc)
        {}
...
size_t hash<::test_object::std_polymorphic_allocator::WalkerObject>::operator()(const ::test_object::std_polymorphic_allocator::WalkerObject& data) const
{
...
size_t hash<::zserio::View<::test_object::std_polymorphic_allocator::WalkerObject>>::operator()(const ::zserio::View<::test_object::std_polymorphic_allocator::WalkerObject>& view) const
{
    uint32_t result = ::zserio::HASH_SEED;
