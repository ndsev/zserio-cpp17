...
#ifndef TEST_OBJECT_STD_POLYMORPHIC_ALLOCATOR_CREATOR_BITMASK_H
#define TEST_OBJECT_STD_POLYMORPHIC_ALLOCATOR_CREATOR_BITMASK_H
...
template <>
struct TypeInfo<::test_object::std_polymorphic_allocator::CreatorBitmask, ::std::pmr::polymorphic_allocator<uint8_t>>
{
...
template <>
struct hash<::test_object::std_polymorphic_allocator::CreatorBitmask>
{
    size_t operator()(const ::test_object::std_polymorphic_allocator::CreatorBitmask& value) const;
};

} // namespace std

#endif // TEST_OBJECT_STD_POLYMORPHIC_ALLOCATOR_CREATOR_BITMASK_H
