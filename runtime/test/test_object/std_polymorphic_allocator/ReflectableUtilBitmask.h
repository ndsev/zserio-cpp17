...
#ifndef TEST_OBJECT_STD_POLYMORPHIC_ALLOCATOR_REFLECTABLE_UTIL_BITMASK_H
#define TEST_OBJECT_STD_POLYMORPHIC_ALLOCATOR_REFLECTABLE_UTIL_BITMASK_H
...
public:
     ...
     */
    ::zserio::std_pmr::String toString(const ::zserio::std_pmr::String::allocator_type& allocator =
            ::zserio::std_pmr::String::allocator_type()) const;
...
template <>
struct TypeInfo<::test_object::std_polymorphic_allocator::ReflectableUtilBitmask, ::std::pmr::polymorphic_allocator<uint8_t>>
{
...
template <>
struct hash<::test_object::std_polymorphic_allocator::ReflectableUtilBitmask>
{
    size_t operator()(const ::test_object::std_polymorphic_allocator::ReflectableUtilBitmask& value) const;
};

} // namespace std

#endif // TEST_OBJECT_STD_POLYMORPHIC_ALLOCATOR_REFLECTABLE_UTIL_BITMASK_H
