...
#include <test_object/std_polymorphic_allocator/CreatorObject.h>
...
CreatorObject::CreatorObject(CreatorObject&& other_, const allocator_type& allocator) :
        value(other_.value),
        nested(std::move(other_.nested), allocator),
        text(std::move(other_.text), allocator),
        nestedArray(std::move(other_.nestedArray), allocator),
        textArray(std::move(other_.textArray), allocator),
        externArray(std::move(other_.externArray), allocator),
        bytesArray(std::move(other_.bytesArray), allocator),
        optionalBool(std::move(other_.optionalBool), allocator),
        optionalNested(std::move(other_.optionalNested), allocator)
{}

CreatorObject::CreatorObject(const CreatorObject& other_, const allocator_type& allocator) :
        value(other_.value),
        nested(other_.nested, allocator),
        text(other_.text, allocator),
        nestedArray(other_.nestedArray, allocator),
        textArray(other_.textArray, allocator),
        externArray(other_.externArray, allocator),
        bytesArray(other_.bytesArray, allocator),
        optionalBool(other_.optionalBool, allocator),
        optionalNested(other_.optionalNested, allocator)
{}

CreatorObject::CreatorObject(
        ::zserio::UInt32 value_,
        ::test_object::std_polymorphic_allocator::CreatorNested nested_,
        ::zserio::std_pmr::String text_,
        ::zserio::std_pmr::Vector<::test_object::std_polymorphic_allocator::CreatorNested> nestedArray_,
        ::zserio::std_pmr::Vector<::zserio::std_pmr::String> textArray_,
        ::zserio::std_pmr::Optional<::zserio::std_pmr::Vector<::zserio::std_pmr::BitBuffer>> externArray_,
        ::zserio::std_pmr::Optional<::zserio::std_pmr::Vector<::zserio::std_pmr::Bytes>> bytesArray_,
        ::zserio::std_pmr::Optional<::zserio::Bool> optionalBool_,
        ::zserio::std_pmr::Optional<::test_object::std_polymorphic_allocator::CreatorNested> optionalNested_,
...
bool operator==(const ::test_object::std_polymorphic_allocator::CreatorObject& lhs, const ::test_object::std_polymorphic_allocator::CreatorObject& rhs)
{
    return ::std::tie(
            lhs.value,
            lhs.nested,
...
View<::test_object::std_polymorphic_allocator::CreatorNested> View<::test_object::std_polymorphic_allocator::CreatorObject>::ZserioNestedArrayArrayTraits::at(const OwnerType& owner,
        const ::test_object::std_polymorphic_allocator::CreatorNested& element, size_t)
{
    return View<::test_object::std_polymorphic_allocator::CreatorNested>(element, ::zserio::UInt32(static_cast<::zserio::UInt32::ValueType>(owner.value())));
}

void View<::test_object::std_polymorphic_allocator::CreatorObject>::ZserioNestedArrayArrayTraits::read(BitStreamReader& reader, const OwnerType& owner,
                ::test_object::std_polymorphic_allocator::CreatorNested& element, size_t)
{
    (void)detail::read(reader, element, ::zserio::UInt32(static_cast<::zserio::UInt32::ValueType>(owner.value())));
}
View<::test_object::std_polymorphic_allocator::CreatorObject>::View(const ::test_object::std_polymorphic_allocator::CreatorObject& data) noexcept :
        m_data(&data)
{}

View<::test_object::std_polymorphic_allocator::CreatorObject>::View(const ::test_object::std_polymorphic_allocator::CreatorObject& data,
        const View&) noexcept :
        m_data(&data)
{}

::zserio::UInt32 View<::test_object::std_polymorphic_allocator::CreatorObject>::value() const
{
    return m_data->value;
}

View<::test_object::std_polymorphic_allocator::CreatorNested> View<::test_object::std_polymorphic_allocator::CreatorObject>::nested() const
{
    return View<::test_object::std_polymorphic_allocator::CreatorNested>{
            m_data->nested, ::zserio::UInt32(static_cast<::zserio::UInt32::ValueType>(value()))};
}

::std::string_view View<::test_object::std_polymorphic_allocator::CreatorObject>::text() const
{
    return ::std::string_view{
            m_data->text};
}

ArrayView<const ::test_object::std_polymorphic_allocator::CreatorNested, View<::test_object::std_polymorphic_allocator::CreatorObject>::ZserioNestedArrayArrayTraits> View<::test_object::std_polymorphic_allocator::CreatorObject>::nestedArray() const
{
    return ArrayView<const ::test_object::std_polymorphic_allocator::CreatorNested, ZserioNestedArrayArrayTraits>{
            m_data->nestedArray, *this};
}

ArrayView<const ::zserio::std_pmr::String> View<::test_object::std_polymorphic_allocator::CreatorObject>::textArray() const
{
    return ArrayView<const ::zserio::std_pmr::String>{
            m_data->textArray};
}

::zserio::std_pmr::Optional<ArrayView<const ::zserio::std_pmr::BitBuffer>> View<::test_object::std_polymorphic_allocator::CreatorObject>::externArray() const
{
    if (m_data->externArray.has_value())
    {
        return ::zserio::std_pmr::Optional<ArrayView<const ::zserio::std_pmr::BitBuffer>>{
                ::std::in_place, m_data->externArray.get_allocator(), *m_data->externArray};
    }
    else
    {
        return ::zserio::std_pmr::Optional<ArrayView<const ::zserio::std_pmr::BitBuffer>>(::std::nullopt, m_data->externArray.get_allocator());
    }
}

::zserio::std_pmr::Optional<ArrayView<const ::zserio::std_pmr::Bytes>> View<::test_object::std_polymorphic_allocator::CreatorObject>::bytesArray() const
{
    if (m_data->bytesArray.has_value())
    {
        return ::zserio::std_pmr::Optional<ArrayView<const ::zserio::std_pmr::Bytes>>{
                ::std::in_place, m_data->bytesArray.get_allocator(), *m_data->bytesArray};
    }
    else
    {
        return ::zserio::std_pmr::Optional<ArrayView<const ::zserio::std_pmr::Bytes>>(::std::nullopt, m_data->bytesArray.get_allocator());
    }
}

::zserio::std_pmr::Optional<::zserio::Bool> View<::test_object::std_polymorphic_allocator::CreatorObject>::optionalBool() const
{
    return m_data->optionalBool;
}

::zserio::std_pmr::Optional<View<::test_object::std_polymorphic_allocator::CreatorNested>> View<::test_object::std_polymorphic_allocator::CreatorObject>::optionalNested() const
{
    if (m_data->optionalNested.has_value())
    {
        return ::zserio::std_pmr::Optional<View<::test_object::std_polymorphic_allocator::CreatorNested>>{
    ...
    {
        return ::zserio::std_pmr::Optional<View<::test_object::std_polymorphic_allocator::CreatorNested>>(::std::nullopt, m_data->optionalNested.get_allocator());
    }
}

const ::test_object::std_polymorphic_allocator::CreatorObject& View<::test_object::std_polymorphic_allocator::CreatorObject>::zserioData() const
{
    return *m_data;
}

bool operator==(const View<::test_object::std_polymorphic_allocator::CreatorObject>& lhs, const View<::test_object::std_polymorphic_allocator::CreatorObject>& rhs)
{
...
template <>
void validate(const View<::test_object::std_polymorphic_allocator::CreatorObject>& view, ::std::string_view)
{
...
template <>
BitSize bitSizeOf(const View<::test_object::std_polymorphic_allocator::CreatorObject>& view, BitSize bitPosition)
{
...
template <>
void write(BitStreamWriter& writer, const View<::test_object::std_polymorphic_allocator::CreatorObject>& view)
{
    auto value_ = view.value();
    write(writer, value_);
    auto nested_ = view.nested();
...
template <>
View<::test_object::std_polymorphic_allocator::CreatorObject> read(BitStreamReader& reader, ::test_object::std_polymorphic_allocator::CreatorObject& data)
{
    View<::test_object::std_polymorphic_allocator::CreatorObject> view(data);
    ...
    (void)readWithTraits<ArrayType::AUTO, View<::test_object::std_polymorphic_allocator::CreatorObject>::ZserioNestedArrayArrayTraits>(reader, data.nestedArray, view);
...
const ::zserio::std_pmr::ITypeInfo& TypeInfo<::test_object::std_polymorphic_allocator::CreatorObject, ::std::pmr::polymorphic_allocator<uint8_t>>::get()
{
    ...
    static const ::std::array<::zserio::BasicFieldInfo<AllocatorType>, 9> fields = {
        ...
        ::zserio::BasicFieldInfo<AllocatorType>{
            "nested", // schemaName
            ::zserio::typeInfo<::test_object::std_polymorphic_allocator::CreatorNested, ::std::pmr::polymorphic_allocator<uint8_t>>(), // typeInfo
        ...
        ::zserio::BasicFieldInfo<AllocatorType>{
            "text", // schemaName
            ::zserio::typeInfo<::zserio::std_pmr::String, ::std::pmr::polymorphic_allocator<uint8_t>>(), // typeInfo
            {}, // typeArguments
            false, // isExtended
            {}, // alignment
            {}, // offset
        ...
        ::zserio::BasicFieldInfo<AllocatorType>{
            ...
            ::zserio::typeInfo<::zserio::std_pmr::BitBuffer, ::std::pmr::polymorphic_allocator<uint8_t>>(), // typeInfo
            {}, // typeArguments
            false, // isExtended
            {}, // alignment
            {}, // offset
        ...
        ::zserio::BasicFieldInfo<AllocatorType>{
            ...
            ::zserio::typeInfo<::zserio::std_pmr::Bytes, ::std::pmr::polymorphic_allocator<uint8_t>>(), // typeInfo
            {}, // typeArguments
            false, // isExtended
            {}, // alignment
            {}, // offset
    ...
    static const ::zserio::detail::StructTypeInfo<AllocatorType> typeInfo = {
        "test_object.std_polymorphic_allocator.CreatorObject",
        [](const AllocatorType& allocator) -> ::zserio::std_pmr::IReflectableDataPtr
        {
            return ::std::allocate_shared<::zserio::ReflectableDataOwner<::test_object::std_polymorphic_allocator::CreatorObject>>(allocator);
        },
...
::zserio::std_pmr::IReflectableDataConstPtr reflectable(
        const ::test_object::std_polymorphic_allocator::CreatorObject& value, const ::std::pmr::polymorphic_allocator<uint8_t>& allocator)
{
    ...
    public:
        ...
        explicit Reflectable(const ::test_object::std_polymorphic_allocator::CreatorObject& object, const ::std::pmr::polymorphic_allocator<uint8_t>& alloc = {}) :
                ::zserio::ReflectableDataConstAllocatorHolderBase<::std::pmr::polymorphic_allocator<uint8_t>>(typeInfo<::test_object::std_polymorphic_allocator::CreatorObject>(), alloc),
                m_object(object)
        {}
    ...
    private:
        const ::test_object::std_polymorphic_allocator::CreatorObject& m_object;
    };
...
::zserio::std_pmr::IReflectableDataPtr reflectable(
        ::test_object::std_polymorphic_allocator::CreatorObject& value, const ::std::pmr::polymorphic_allocator<uint8_t>& allocator)
{
    ...
    public:
        ...
        explicit Reflectable(::test_object::std_polymorphic_allocator::CreatorObject& object, const ::std::pmr::polymorphic_allocator<uint8_t>& alloc = {}) :
                ::zserio::ReflectableDataAllocatorHolderBase<::std::pmr::polymorphic_allocator<uint8_t>>(typeInfo<::test_object::std_polymorphic_allocator::CreatorObject>(), alloc),
                m_object(object)
        {}
        ...
        void setField(::std::string_view name, const ::zserio::std_pmr::Any& value) override
        {
            ...
            if (name == "nested")
            {
                m_object.nested = ::zserio::ReflectableUtil::fromAny<::test_object::std_polymorphic_allocator::CreatorNested>(value);
                return;
            }
            if (name == "text")
            {
                m_object.text = ::zserio::ReflectableUtil::fromAny<::zserio::std_pmr::String>(value);
                return;
            }
            if (name == "nestedArray")
            {
                m_object.nestedArray = ::zserio::ReflectableUtil::fromAny<::zserio::std_pmr::Vector<::test_object::std_polymorphic_allocator::CreatorNested>>(value);
                return;
            }
            if (name == "textArray")
            {
                m_object.textArray = ::zserio::ReflectableUtil::fromAny<::zserio::std_pmr::Vector<::zserio::std_pmr::String>>(value);
                return;
            }
            if (name == "externArray")
            {
                ...
                m_object.externArray = ::zserio::ReflectableUtil::fromAny<::zserio::std_pmr::Vector<::zserio::std_pmr::BitBuffer>>(value);
                return;
            }
            if (name == "bytesArray")
            {
                ...
                m_object.bytesArray = ::zserio::ReflectableUtil::fromAny<::zserio::std_pmr::Vector<::zserio::std_pmr::Bytes>>(value);
                return;
            }
            if (name == "optionalBool")
            {
            ...
            if (name == "optionalNested")
            {
                ...
                m_object.optionalNested = ::zserio::ReflectableUtil::fromAny<::test_object::std_polymorphic_allocator::CreatorNested>(value);
                return;
            }
            throw ::zserio::CppRuntimeException("Field '") << name << "' doesn't exist in 'CreatorObject'!";
        }
        ...
        ::zserio::std_pmr::IReflectableDataPtr createField(::std::string_view name) override
        {
            ...
            if (name == "nested")
            {
                m_object.nested = ::test_object::std_polymorphic_allocator::CreatorNested(get_allocator());
                return ::zserio::reflectable(m_object.nested, get_allocator());
            }
            if (name == "text")
            {
                m_object.text = ::zserio::std_pmr::String(get_allocator());
                return ::zserio::reflectable(m_object.text, get_allocator());
            }
            if (name == "nestedArray")
            {
                m_object.nestedArray = ::zserio::std_pmr::Vector<::test_object::std_polymorphic_allocator::CreatorNested>(get_allocator());
                return ::zserio::reflectableArray(m_object.nestedArray, get_allocator());
            }
            if (name == "textArray")
            {
                m_object.textArray = ::zserio::std_pmr::Vector<::zserio::std_pmr::String>(get_allocator());
                return ::zserio::reflectableArray(m_object.textArray, get_allocator());
            }
            if (name == "externArray")
            {
                m_object.externArray = ::zserio::std_pmr::Vector<::zserio::std_pmr::BitBuffer>(get_allocator());
                return ::zserio::reflectableArray(*m_object.externArray, get_allocator());
            }
            if (name == "bytesArray")
            {
                m_object.bytesArray = ::zserio::std_pmr::Vector<::zserio::std_pmr::Bytes>(get_allocator());
                return ::zserio::reflectableArray(*m_object.bytesArray, get_allocator());
            }
            if (name == "optionalBool")
            {
            ...
            if (name == "optionalNested")
            {
                m_object.optionalNested = ::test_object::std_polymorphic_allocator::CreatorNested(get_allocator());
                return ::zserio::reflectable(*m_object.optionalNested, get_allocator());
            }
            throw ::zserio::CppRuntimeException("Field '") << name << "' doesn't exist in 'CreatorObject'!";
        }
    ...
    private:
        ::test_object::std_polymorphic_allocator::CreatorObject& m_object;
    };
...
template <>
::zserio::std_pmr::IIntrospectableViewConstPtr introspectable(const View<::test_object::std_polymorphic_allocator::CreatorObject>& view, const ::std::pmr::polymorphic_allocator<uint8_t>& allocator)
{
    class Introspectable : public ::zserio::CompoundIntrospectableViewBase<::test_object::std_polymorphic_allocator::CreatorObject, ::std::pmr::polymorphic_allocator<uint8_t>>
    {
    public:
        explicit Introspectable(const ::zserio::View<::test_object::std_polymorphic_allocator::CreatorObject>& view_, const ::std::pmr::polymorphic_allocator<uint8_t>& alloc = {}) :
                ::zserio::CompoundIntrospectableViewBase<::test_object::std_polymorphic_allocator::CreatorObject, ::std::pmr::polymorphic_allocator<uint8_t>>(
                        view_, alloc)
        {}
...
size_t hash<::test_object::std_polymorphic_allocator::CreatorObject>::operator()(const ::test_object::std_polymorphic_allocator::CreatorObject& data) const
{
...
size_t hash<::zserio::View<::test_object::std_polymorphic_allocator::CreatorObject>>::operator()(const ::zserio::View<::test_object::std_polymorphic_allocator::CreatorObject>& view) const
{
    uint32_t result = ::zserio::HASH_SEED;
