...
{
    checkDecoderSuccess("\"\"", 2, StringType(""));
    checkDecoderSuccess("\"test\"", 6, StringType("test"));
    checkDecoderSuccess("\"München\"", 10, StringType("München"));
    checkDecoderSuccess("\"€\"", 5, StringType("€"));

    // escapes
    checkDecoderSuccess("\"\\\\\"", 4, StringType("\\"));
    checkDecoderSuccess("\"\\\"\"", 4, StringType("\""));
    checkDecoderSuccess("\"\\b\"", 4, StringType("\b"));
    checkDecoderSuccess("\"\\f\"", 4, StringType("\f"));
    checkDecoderSuccess("\"\\n\"", 4, StringType("\n"));
    checkDecoderSuccess("\"\\r\"", 4, StringType("\r"));
    checkDecoderSuccess("\"\\t\"", 4, StringType("\t"));
    ...
    // <= 0x1F -> unicode escape
    checkDecoderSuccess("\"\\u001f\"", 8, StringType("\x1F"));
