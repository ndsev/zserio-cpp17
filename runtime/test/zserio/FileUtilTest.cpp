...
{
    std::string_view fileName("FileUtilTest_byteBufferBitSize.bin");
...
{
    std::string_view fileName("FileUtilTest_byteBufferByteSize.bin");
...
{
    std::string_view fileName("FileUtilTest_bitBuffer.bin");
