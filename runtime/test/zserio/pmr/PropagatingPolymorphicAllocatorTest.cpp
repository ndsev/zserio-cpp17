...
{
    pmr::PropagatingPolymorphicAllocator<std::byte> allocator;
    ASSERT_EQ(std::pmr::get_default_resource(), allocator.resource());

    TestResource resource;

    pmr::PropagatingPolymorphicAllocator<std::byte> allocator2(&resource);
    ASSERT_EQ(&resource, allocator2.resource());

    pmr::PropagatingPolymorphicAllocator<std::byte> allocator2Copy(allocator2);
    ASSERT_EQ(&resource, allocator2Copy.resource());

    pmr::PropagatingPolymorphicAllocator<std::byte> allocator2Moved(std::move(allocator2));
    ASSERT_EQ(&resource, allocator2Moved.resource());
}
...
{
    TestResource resource;
    pmr::PropagatingPolymorphicAllocator<std::byte> allocator(&resource);
    pmr::PropagatingPolymorphicAllocator<int> allocatorRebind(allocator);
    ASSERT_EQ(&resource, allocatorRebind.resource());
}
...
{
    pmr::PropagatingPolymorphicAllocator<std::byte> allocator;
    pmr::PropagatingPolymorphicAllocator<std::byte> allocator2;
    ASSERT_TRUE(allocator == allocator2);
    ASSERT_FALSE(allocator != allocator2);

    TestResource resource;

    pmr::PropagatingPolymorphicAllocator<std::byte> allocatorRes(&resource);
    pmr::PropagatingPolymorphicAllocator<std::byte> allocatorRes2(&resource);
    ASSERT_TRUE(allocatorRes == allocatorRes2);
    ASSERT_FALSE(allocatorRes != allocatorRes2);
    ASSERT_FALSE(allocatorRes == allocator);
    ASSERT_TRUE(allocatorRes != allocator);
